...
class Tiktokforbusiness {
	 ...
	 * @var string[]
	 */
	private static $current_tiktok_for_woocommerce_version = '1.2.1';
	...
	public function initialize_hooks() {
		...
		register_deactivation_hook( __FILE__, array( self::class, 'tt_plugin_deactivate' ) );
		register_activation_hook( __FILE__, array( self::class, 'tt_plugin_activate' ) );
	}
