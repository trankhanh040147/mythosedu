...
<div class="tutor-admin-wrap">
	<div class="tutor-wp-dashboard-header tutor-px-24 tutor-pt-32 tutor-pb-20">
		...
		<div class="tutor-row tutor-gx-xl-5 tutor-fs-6">
			...
			<div class="tutor-col-auto tutor-my-12">
				<span class="tutor-color-black tutor-fw-medium"><?php esc_html_e( 'Submitted Date', 'tutor-pro' ); ?>:</span> <span class="tutor-color-secondary"><?php esc_html_e( tutor_utils()->get_local_time_from_unix( $submitted_assignment->comment_date_gmt ) ); ?></span>
			</div>
		</div>
	</div>
