H5P.AFrameOrbitControls = (function () {

  // Constructor to invoke AFrame initialization when needed
	function H5PAFrameOrbitControls() {
	...
	H5PAFrameOrbitControls.prototype.constructor = H5PAFrameOrbitControls;

  return H5PAFrameOrbitControls;
