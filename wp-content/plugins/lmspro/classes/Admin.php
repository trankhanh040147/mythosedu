...
class Admin {
	...
	public function __construct() {
		/**
		 * Load Conditional Constructor based on if LMS wordpress.org plugin installed or not
		 *
		 * @since v.1.0.0
		 *
		 * @updated v.1.4.9
	...
	public function register_menu() {
		if ( ! defined( 'TUTOR_VERSION' ) ) {
			add_menu_page( __( 'LMS Content', 'tutor-pro' ), __( 'LMS Content', 'tutor-pro' ), 'manage_tutor_instructor', 'tutor-install', array( $this, 'install_activate_tutor_free' ), 'dashicons-welcome-learn-more', 2 );
		}
	}
		...
		<div class="notice notice-error tutor-install-notice">
			<div class="tutor-install-notice-inner">
				...
				<div class="tutor-install-notice-content">
					<h2><?php esc_html_e( 'Thanks for using LMS Content', 'tutor-pro' ); ?></h2>
					<p><?php esc_html_e( 'You must have ', 'tutor-pro' ); ?>
						<a href="https://wordpress.org/plugins/tutor/" target="_blank">
							<?php esc_html_e( 'LMS ', 'tutor-pro' ); ?>
						</a>
						<?php esc_html_e( 'Free version installed and activated on this website in order to use LMS Content.', 'tutor-pro' ); ?>
					</p>
					<a href="https://docs.themeum.com/tutor-lms/" target="_blank">
						<?php esc_html_e( 'Learn more about LMS', 'tutor-pro' ); ?>
					</a>
				</div>
				<div class="tutor-install-notice-button">
					<a class="button button-primary" href="<?php echo add_query_arg( array( 'action' => 'activate_tutor_free' ), admin_url() ); ?>">
						<?php esc_html_e( 'Activate LMS', 'tutor-pro' ); ?>
					</a>
				</div>
			</div>
		</div>
	...
	public function free_plugin_not_installed() {
		...
		<div class="notice notice-error tutor-install-notice">
			<div class="tutor-install-notice-inner">
				...
				<div class="tutor-install-notice-content">
					<h2>Thanks for using LMS Content</h2>
					<p>You must have <a href="https://wordpress.org/plugins/tutor/" target="_blank">LMS </a> Free version installed and activated on this website in order to use Tutor Pro.</p>
					<a href="https://docs.themeum.com/tutor-lms/" target="_blank">Learn more about LMS</a>
				</div>
				<div class="tutor-install-notice-button">
					<a class="install-tutor-button tutor-btn" data-slug="tutor" href="<?php echo add_query_arg( array( 'action' => 'install_tutor_free' ), admin_url() ); ?>">Install LMS</a>
				</div>
			</div>
