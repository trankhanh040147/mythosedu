		...
		<div class="notice notice-error tutor-install-notice" style="display:flex; tutor-justify: space-between; align-items: center;">
			<div class="tutor-install-notice-inner" style="display: flex; column-gap: 20px;">
				...
				<div class="tutor-install-notice-content">
					<h2><?php esc_html_e( 'WARNING: YOU NEED TO INSTALL THE REQUIRED LMS VERSION', 'tutor-pro' ); ?></h2>
					<p>
						<?php
							$notice = __( 'It seems you have installed the wrong version Of LMS. For a smoother LMS experience, you need to install LMS ' . TUTOR_CORE_REQ_VERSION . ' (Free) version.', 'tutor-pro' );
							echo esc_html( $notice );
						?>
					</p>
					<p style="color: #757C8E;">
						<?php esc_html_e( 'Note: LMS Content will be installed but you will not be able to avail any of its’ features.', 'tutor-pro' ); ?>
					</p>
				</div>
			</div>
