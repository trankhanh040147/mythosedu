=== LMS - eLearning and online course solution ===
...
LMS is a complete, feature-packed, and robust WordPress LMS plugin to easily create & sell courses online. All the features of this learning management system hit all the checkpoints for a full-fledged online course marketplace. 
...
👉 [LMS](https://www.themeum.com/product/tutor-lms/)
👉 [LMS Themes](https://www.themeum.com/wordpress-themes/) 
...
Want to know all the latest news and be part of the LMS community? Join our [Facebook LMS Community group!](https://www.facebook.com/groups/tutorlms)

Also check out our overview video [youtube https://www.youtube.com/watch?v=Eu9cVlNATwk]

LMS is a completely free WordPress LMS plugin. It comes with premium high-quality add-ons that you can add to empower the core plugin more! This WordPress LMS plugin is lightweight with add-ons to enable certificates, e-mail notifications, shopping carts and so much more!

🔥 [Get LMS] (https://www.themeum.com/product/tutor-lms/), the most advanced and powerful WordPress online course plugin.
...
🙆 “After hours and hours of research and trying several LMS platforms, I have decided to purchase LMS. I’ve run into some bugs, but they were quickly solved by their customer support team. I’m using it for some time now and have been able to check out the V2 beta. It will be a great step and make this amazing LMS even better!” —nowhereman78
...
🙆 “LMS is an excellent plugin. LMS is very powerful, the course tab, the profile system (specially the profile page) and the course list. And the support is fast and efficient!!” —jrox10
...
* Here are the most notable features of LMS plugin. If you need any further information, please feel free to contact us. Below are the best offerings of LMS.
...
= LMS Extended Features =

LMS can be used by anyone looking to create a full-fledged learning management system. Some of the great applications of LMS include the following.
* Blended learning
* Community education
* Online classroom
* Training courses
* Professional continuing education
* These are just a few possibilities that LMS opens up for its users. There’s a whole new world of intuitive learning that’s yet to discover using this WordPress LMS plugin.

= MINIMALISTIC AND UNIFORM DESIGN =

With a minimalistic and uniform design, LMS gives you the best user experience that is easy on the eyes and also easy to use. With the idea that less is more, the entire interface has gotten a facelift and the various color inconsistencies have been resolved. Its also been improved in terms of accessibility to make things easier for any user with disabilities.
...
The withdrawal option in LMS helps manage withdrawals easily. You can predefine the minimum amount in this WordPress LMS plugin that needs to be earned before instructors can send a withdrawal request. It also comes with the option to select the withdrawal method such as bank transfer, PayPal, and ECHECK. If you want to add additional information on withdrawal you can do so too with this WordPress LMS plugin. Easily view all the withdrawal information from your dashboard displaying current balance, pending, completed, and rejected withdrawal stats.

= PURCHASE HISTORY =

Keep track of all the purchase options using the purchase history in the dashboard in the WordPress LMS plugin. Check the purchase status, amount, and when the purchase was made inside LMS.

= SPOTLIGHT MODE =

LMS comes with the setting to hide the header & footer for the course learning interface. Offer students a distraction-free lesson with the spotlight mode option.

= GUTENBERG COMPATIBLE =

Create online courses with the new Gutenberg editor without facing any issues whatsoever in the innovative WordPress LMS plugin. LMS is completely compatible with the Gutenberg editor in case you want to display your courses in the block interface. Moreover, LMS comes with three custom Gutenberg blocks. The blocks are - Tutor Student Dashboard, Student Registration, and Instructor Registration Form.
...
* Tutor Paid Memberships Pro: Subscriptions are made easy with the Tutor Paid Membership pro addon. Using the Tutor Paid Memberships Pro plugin integration with LMS, include site-wise and category-wise subscriptions for your eLearning platform.
...
* Frontend Course Builder: Build your course on the go using the frontend course builder in the LMS plugin. Instructors can see how their course looks live without even having to go backend. The industry-first frontend course builder in any WordPress LMS plugin ever.
...
Update: LMS is now compatible with the latest WooCommerce Subscriptions plugin
...
Fix: PHP Notices were appearing while installing the LMS Certificate Builder plugin
...
Fix: WooCommerce "Autocomplete Order" Hook was not working with LMS
...
Update: Introducing WP 5.9 Compatibility for LMS 2.0
Update: Introducing WPML Compatibility for LMS 2.0
Update: PHP-8 compatibility for LMS 2.0 
...
Fix: Date picker format not applying issue for all the places in LMS
...
Fix: Date Formats of LMS were not matched with the set WordPress date format
...
Fix: Header footer shown twice while using Oxygen LMS integration
...
Update: Improved Queuing system for LMS announcement and content drip email
...
Fix: Add New Course, Explore Addons buttons issue in LMS setup wizard
...
New: Duplicate any course from the LMS course list
...
Update: User can disable LMS native login system
...
* Fix: LMS > Enrollments is showing same date for all items
...
* LMS plugin is now running under 'plugins_loaded' hook (Architectural update)
...
* New: BuddyPress Integration (TutorLMS Content)
...
* Fix: fatal error when LMS regular version is not exists

= 1.4.8 - 10 December, 2019 =

* New: Restrict Content Pro Integration (TutorLMS Content)
...
* New: Reset Password, LMS native login system
* New: re-generate tutor pages, create new page if any issue on those page.
* New: Added quiz attempt view by student (TutorLMS Content)
...
* New: Frontend Course Builder Page Logo Upload Option, Settings > General > LMS Content Settings
...
* New: Greadbook Addons in the LMS Content version
...
* Fix: LMS Content addon loading issue on the windows machine
...
* New: add to cart guest mode in WooCommerce integration based on LMS > settings > woocommerce
...
* New: Pro text in the LMS dashboard menu when Tutor Pro plugin installed and activated
...
* New: Enable Disable Course Market place, default LMS will be single instructor format.
...
* New: RTL CSS support
* New: Footer text only on LMS pages in admin dashboard
...
* New: Drop LMS related database table while uninstalling
