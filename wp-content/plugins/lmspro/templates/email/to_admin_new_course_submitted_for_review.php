		...
		<div class="tutor-email-wrapper" style="background-color: #fff;">
			...
			<div class="tutor-email-content" <?php echo isset( $email_banner_background ) ? $email_banner_background : ''; ?>>
				...
				<div class="tutor-email-buttons">
					<a href="{course_edit_url}" data-source="email-btn-url" class="tutor-email-button-bordered"><?php echo __( 'Publish Now', 'tutor-pro' ); ?></a>
					<a href="{course_url}" data-source="email-btn-url" class="tutor-email-button"><?php echo __( 'See Course', 'tutor-pro' ); ?></a>
				</div>
			</div>
