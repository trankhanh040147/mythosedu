...
Description: Take advanced control on enrolment list. Enroll student manually.
Author: Themeum
Version: 1.0.0
...
function tutor_enrollments_config($config){
	$newConfig = array(
		'name'          => __('Enrolment', 'tutor-pmpro'),
		'description'   => __('Take advanced control on enrolment. Enroll the student manually.', 'tutor-pro'),
	);
