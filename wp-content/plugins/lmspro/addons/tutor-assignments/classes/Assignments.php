...
class Assignments {
	...
	public function __construct() {
		...
		add_action( 'tutor/assignment/right_icon_area', array( $this, 'show_assignment_submitted_icon' ) );
	...
	public function tutor_modal_create_or_update_assignment() {
		...
		// @since v2.0.0
		$percentage_point = isset( $assignment_option['percentage_point'] ) ? sanitize_text_field( $assignment_option['percentage_point'] ) : 0;
	...
	public static function remove_assignment_attachment():void {
		tutor_utils()->checking_nonce();
		$assignment_comment_id = sanitize_text_field( $_POST['assignment_comment_id'] );
