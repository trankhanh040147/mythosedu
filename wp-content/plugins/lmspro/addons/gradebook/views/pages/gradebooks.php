		...
		<div class="tutor-mt-24">
			<div class="tutor_admin_gradebook_list tutor-table-wrapper">
				...
				if ( tutor_utils()->count( $gradebooks ) ) {
					?>
					<table class="tutor-table tutor-table-responsive tutor-gradebooks-lists">
						<thead>
							<tr>
								<th>
									...
									<tr>
										...
										<td data-th="<?php esc_html_e( 'Actions', 'tutor-pro' ); ?>">
											<div class="tutor-d-inline-flex tutor-align-center td-action-btns">
												...
												<a href="<?php echo add_query_arg(array('tutor_action' => 'delete_gradebook', 'gradebook_id' => $gradebook->gradebook_id)); ?>" class="gradebook-delete-btn tutor-btn tutor-btn-outline-primary tutor-btn-sm" onclick="return confirm('<?php esc_html_e( 'Are you Sure?', 'tutor-pro' ); ?>')">
