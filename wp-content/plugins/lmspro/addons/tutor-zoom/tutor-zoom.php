...
Description: Connect LMS with Zoom to host live online classes. Students can attend live classes right from the lesson page.
Author: Themeum
Version: 1.0.0
...
function tutor_zoom_config($config) {
	$newConfig = array(
		...
		'description'   => __('Connect LMS with Zoom to host live online classes. Students can attend live classes right from the lesson page.', 'tutor-pro'),
	);
