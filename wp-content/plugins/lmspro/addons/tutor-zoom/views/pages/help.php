            ...
            <div class="tutor-zoom-settings">
                ...
                <div class="tutor-zoom-accordion-item tutor-card tutor-p-16 tutor-mb-16">
                    ...
                    <div class="tutor-zoom-accordion-body tutor-pt-16" style="display: none;">
                        <div class="tutor-fs-7 tutor-color-secondary">
                            <?php _e('To connect Zoom with your eLearning website powered by LMS, you need to first create an app on Zoom by following this link. Then create a JWT, copy the API Credentials, and paste it to the LMS backend by navigating to <strong>WP Admin > LMS Content > Zoom > Set API</strong>.', 'tutor-pro'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="tutor-zoom-accordion-item tutor-card tutor-p-16 tutor-mb-16">
                    <div class="tutor-zoom-accordion-panel">
                        <span class="tutor-zoom-accordion-panel-handler tutor-d-flex tutor-align-center tutor-cursor-pointer">
                            <span class="tutor-iconic-btn tutor-iconic-btn-secondary"><i class="tutor-icon-angle-down"></i></span>
                            <span class="tutor-accordion-panel-handler-label tutor-fs-6 tutor-fw-medium tutor-color-black tutor-ml-24"><?php _e('How Do I Create a Live Lesson on LMS?', 'tutor-pro'); ?></span>
                        </span>
                    </div>

                    <div class="tutor-zoom-accordion-body tutor-pt-16" style="display: none;">
                        <div class="tutor-fs-7 tutor-color-secondary">
                            <?php _e('You can create a live lesson by going into any LMS course editor. There, you will see a section called Zoom Meeting from where you can schedule a General Zoom meeting. You can also add lesson-specific meetings by navigating into any topic and then selecting the <strong>Zoom Live Lesson</strong> option.', 'tutor-pro'); ?>
                        </div>
                    </div>
                </div>
