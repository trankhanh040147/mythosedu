...
<?php if ( count( $classes ) ) : ?>
    <table class="tutor-table tutor-table-responsive google-classroom-class-list tutor-mb-48">
        <thead>
            <tr>
                <th width="1%">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td data-th="<?php _e('Action', 'tutor-pro'); ?>" data-class_actions id="tutor-gc-status" class="<?php echo 'class-status-' . $class_; ?>">
