...
function tutor_gc_config($config){
	$newConfig = array(
		...
		'description'   => __('Helps connect Google Classrooms with LMS courses, allowing you to use features like Classroom streams and files directly from the LMS course.', 'tutor-pro'),
	);
