...
<div class="analytics-student-details tutor-user-public-profile tutor-user-public-profile-pp-circle">
    <div class="back-wrapper">
        <a class="tutor-btn tutor-btn-ghost" href="<?php echo esc_url( tutor_utils()->tutor_dashboard_url().'analytics/students' );?>">
            <i class="tutor-icon-previous tutor-mr-12" area-hidden="true"></i> <?php _e( 'Back', 'tutor-pro' ); ?>
        </a>
    </div>
    ...
    <div class="student-details-table-wrapper">
        ...
        <div class="tutor-table-wrapper">
            <table class="tutor-table tutor-table-responsive tutor-table-analytics-student-details">
                <thead>
                    <th>
