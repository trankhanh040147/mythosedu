		...
		<div class="tutor-email-wrapper" style="background-color: #fff;">
			...
			<div class="tutor-email-content" <?php echo isset( $email_banner_background ) ? $email_banner_background : ''; ?>>
				...
				<div class="tutor-email-buttons">
					<a target="_blank" class="tutor-email-button-bordered" href="{course_edit_url}"><?php echo __( 'Edit Course', 'tutor-pro' ); ?></a>
					<a target="_blank" class="tutor-email-button" href="{course_url}"><?php echo __( 'See Course', 'tutor-pro' ); ?></a>
				</div>
