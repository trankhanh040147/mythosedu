...
?>
<div class="tutor-modal tutor-modal-scrollable tutor-zoom-meeting-modal-wrap<?php echo is_admin() ? ' tutor-admin-design-init' : ''; ?>" id="<?php echo $modal_id; ?>">
    ...
    <div class="tutor-modal-window">
        <div class="tutor-modal-content">
            ...
            <div class="tutor-modal-body modal-container">
                    ...
                    <div class="meeting-modal-form-wrap">
                        ...
                        <div class="tutor-mb-16 tutor-row">
                            <div class="tutor-col-6">
                                ...
                                <select data-name="meeting_timezone" class="tutor-form-control">
