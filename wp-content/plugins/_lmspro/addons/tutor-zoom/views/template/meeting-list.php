...
?>
<div class="tutor-table-wrapper tutor-mb-24">
	<table class="tutor-table tutor-table-responsive tutor-table-zoom">
		<thead>
			<tr>
				<?php
				foreach ( $table_columns as $key => $column ) {
					if ( $key == 'start_time' ) {
						...
						<th class="tutor-table-rows-sorting">
							<div class="tutor-d-flex tutor- tutor-align-center tutor-fs-7 tutor-color-secondary">
					...
					echo '<th>
						<span class="tutor-fs-7 tutor-color-secondary">' . $column . '</span>
					</th>';
				}
				?>
			</tr>
