...
use DeliciousBrains\WPMDB\Container\DI\Definition\Helper\ArrayDefinitionExtensionHelper;
use DeliciousBrains\WPMDB\Container\DI\Definition\Helper\EnvironmentVariableDefinitionHelper;
use DeliciousBrains\WPMDB\Container\DI\Definition\Helper\FactoryDefinitionHelper;
use DeliciousBrains\WPMDB\Container\DI\Definition\Helper\ObjectDefinitionHelper;
use DeliciousBrains\WPMDB\Container\DI\Definition\Helper\StringDefinitionHelper;
use DeliciousBrains\WPMDB\Container\DI\Definition\Helper\ValueDefinitionHelper;
if (!\function_exists('DeliciousBrains\\WPMDB\\Container\\DI\\value')) {
    /**
