	...
	public static function get_all() {
		return array(
			...
			array(
				...
				'content'             => __( 'Affirm’s tailored Buy Now Pay Later Tags remove price as a barrier, turning browsers into buyers, increasing average order value, and expanding your customer base.', 'woocommerce' ),
