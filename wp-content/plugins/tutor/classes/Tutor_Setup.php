								...
								<li>
									<div class="tutor-setup-content-heading greetings">
										...
										<div class="content">
											...
											<p><?php _e( 'LMS is up and running on your website! If you really want to become a LMS genius, read our <a target="_blank" href="https://docs.themeum.com/tutor-lms/">documentation</a> that covers everything!', 'tutor' ); ?></p>
				...
				<div class="tutor-wrapper-boarding tutor-setup-wizard-boarding active">
					<div class="wizard-boarding-header">
						...
						<div>
							...
							<?php printf( __( 'Hello %s, welcome to LMS!', 'tutor' ), $current_user->user_login ); ?>
							</div>
					...
					<div class="wizard-boarding-body tutor-mt-60">
						<ul class="slider tutor-boarding">
							<li>
								...
								<?php _e( 'From individual instructors to vast eLearning platforms, LMS grows with you to create your ideal vision of an LMS website.', 'tutor' ); ?>
								</div>
							</li>
							<li>
								<div class="slide-thumb">
								...
								<div class="slide-subtitle tutor-text-regular-body tutor-color-text-subsued tutor-mt-16">
								<?php _e( 'LMS comes with a state-of-the-art frontend course builder. Construct rich and resourceful courses with ease.', 'tutor' ); ?>
								</div>
							</li>
							<li>
								<div class="slide-thumb">
