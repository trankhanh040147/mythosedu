...
add_action(
	...
	function() {
		...
		if ( $show ) {
			$message = __( 'Since WooCommerce is disabled, your monetized courses have been set to free. Please make sure to enable LMS monetization if you decide to re-enable WooCommerce.', 'tutor' );
