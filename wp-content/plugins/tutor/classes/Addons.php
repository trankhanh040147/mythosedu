	...
	public function tutor_addons_lists_to_show() {
		$addons = array(
			...
			'tutor-zoom'               => array(
				...
				'description' => __( 'Connect LMS with Zoom to host live online classes. Students can attend live classes right from the lesson page.', 'tutor' ),
			),
			'google-classroom'         => array(
				'name'        => __( 'Google Classroom Integration', 'tutor' ),
				'description' => __( 'Helps connect Google Classrooms with LMS courses, allowing you to use features like Classroom streams and files directly from the LMS course.', 'tutor' ),
			),
