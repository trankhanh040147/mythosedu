...
<div id="tutor-metabox-course-settings-tabs" class="tutor-course-settings-tabs">
    <div class="course-settings-tabs-container">
        <div class="settings-tabs-navs-wrap-remove">
									...
									<?php
										switch($field['type']) {
											case 'number' :
												...
												break;
											case 'text' :
												echo '<input style="max-width:126px !important;" class="tutor-form-control" type="text" name="' . $field_key . '" value="' . $value . '"  min="0">';
												break;
												case 'radio' :
