<div class="tutor-course-instructors-metabox-wrap">
	...
	/*
	 if ( ! defined('TUTOR_MT_VERSION')){
		 echo '<p>'. sprintf( __('To add unlimited multiple instructors in your course, get %sTutor LMS Content%s addon ', 'tutor'), '<a href="https://www.themeum.com/product/tutor-lms" target="_blank">', "</a>" ) .'</p>';
	 }*/
	?>
</div>
