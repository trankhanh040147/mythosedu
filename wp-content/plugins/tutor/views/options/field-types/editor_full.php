...
<div class="tutor-option-field-row tutor-d-block" id="<?php echo esc_attr( $field_id ); ?>">
	...
	<div class="tutor-option-field-input">
		<div class="tutor-wp-editor" style="position: relative;">
			...
			<?php
			$content_demo = '<p style="text-align:center;font-weight:500;color:#41454F;padding-top:30px;">More than 50,000+ eLearning creators just like you <br> who’ve used LMS</p>
