        ...
        <div class="tutor-modal-inner">
            ...
            <div class="tutor-modal-body-alt">
                <div class="tutor-mb-32">
                    <label class="tutor-fs-7 tutor-fw-medium tutor-color-black-70 tutor-mb-4 d-block"><?php _e('Section Name', 'tutor'); ?></label>
                    <div class="tutor-input-group tutor-mb-16">
                        ...
                        <p class="tutor-input-feedback tutor-has-icon">
                            ...
                            <?php _e('Section titles are displayed publicly wherever required. Each section may contain one or more lessons, quiz and assignments.', 'tutor'); ?>
                        </p>
                    </div>
                </div>
                <div>
                    <label class="tutor-fs-7 tutor-fw-medium tutor-color-black-70 tutor-mb-4 d-block"><?php _e('Section Summary', 'tutor'); ?></label>
                    <div class="tutor-input-group tutor-mb-16">
                        <textarea name="topic_summery" class="tutor-form-control tutor-mb-12"><?php echo !empty($data['summary']) ? $data['summary'] : ''; ?></textarea>
                        <p class="tutor-input-feedback tutor-has-icon">
                            <i class="tutor-icon-info-circle-outline-filled tutor-input-feedback-icon"></i>
                            <?php _e('Add a summary of short text to prepare students for the activities for the section. The text is shown on the course page beside the tooltip beside the section name.', 'tutor'); ?>
                        </p>
