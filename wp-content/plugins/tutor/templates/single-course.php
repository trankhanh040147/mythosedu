...
<div <?php tutor_post_class('tutor-full-width-course-top tutor-course-top-info tutor-page-wrap'); ?>>
    ...
    <div class="feature-banner">
        <?php  // course banner - get feature image 
        ...
        <div class="tutor-course-thumbnail-bg tutor-text-center">
            <img src="https://traininghub-uat.vus.edu.vn/wp-content/uploads/2022/07/Rectangle-19.jpg">
        </div>

        <div class="row tutor-container __course_info"><?php (isset($is_enrolled) && $is_enrolled) ? tutor_course_enrolled_lead_info() : tutor_course_lead_info(); ?></div>
