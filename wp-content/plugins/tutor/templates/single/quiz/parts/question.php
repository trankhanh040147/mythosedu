					...
					<?php if ( $question_layout_view !== 'question_below_each_other' ) : ?>
						<div class="tutor-quiz-btn-grp tutor-mt-60 tutor-d-flex">
							...
							<?php if ( ! isset( $question_settings['answer_required'] ) ) : ?>
								<span class=" text-white tutor-ml-32 tutor-btn tutor-btn-disable-outline tutor-no-hover tutor-btn-md tutor-next-btn <?php echo $next_question ? 'tutor-quiz-answer-next-btn' : 'tutor-quiz-submit-btn'; ?> " style="border: 0px; padding: 0px; margin-left: auto;">
