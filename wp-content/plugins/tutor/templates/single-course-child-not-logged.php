    ...
    <div class="tutor-course-details-page tutor-container">
						...
						<div>
							<span>
								...
								if (is_array($course_categories) && count($course_categories)) {
									...
									_e('Uncategorized', TPL_DOMAIN_LANG);
								}
								?>
							</span>
						</div>
				...
				<?php                 
					...
					<div class="tutor-course-details-widget tutor-course-details-widget-col-1 tutor-mt-lg-50 tutor-mt-32">
						...
						<div>
							...
							<span class="">
								<?php
									echo __( "Total length", TPL_DOMAIN_LANG);	
								?>
							</span>
							*/
							?>
									...
									<div class="tutor-fs-5 tutor-fw-bold mb-3 mt-3">
										<span>
											<?php
												...
												echo esc_html( $review_title, TPL_DOMAIN_LANG);
											?>
										</span>
									</div>
								</div>
									...
									<div class="tutor-ratingsreviews-ratings-avg tutor-text-center">
										...
										<div class="tutor-total-ratings-text tutor-fs-6 tutor-fw-normal text-subsued tutor-mt-12">
											<span class="tutor-rating-text-part">
												<?php esc_html_e( 'Total ', TPL_DOMAIN_LANG); ?>
											</span>
											<span class="tutor-rating-count-part">
												<?php echo esc_html( count( $reviews ) ); ?>
											</span>
											<span class="tutor-rating-text-part">
												<?php echo esc_html( _n( ' Rating', ' Ratings', count( $reviews ), TPL_DOMAIN_LANG) ); ?>
											</span>
										</div>
									</div>
										...
										<?php foreach ( $rating->count_by_value as $key => $value ) : ?>
											...
											<div class="rating-numbers">
												...
												<div class="rating-num tutor-fs-7 tutor-fw-normal tutor-color-black-60">
													<?php
														echo $value . ' ';
														echo $value > 1 ? __( 'ratings', TPL_DOMAIN_LANG) : __( 'rating', TPL_DOMAIN_LANG);
													?>
												</div>
											</div>
										<?php endforeach; ?>
								...
								<?php if($is_enrolled): ?>
									<button class="tutor-btn write-course-review-link-btn">
										...
										<?php
											...
											$is_new ? _e('Write a review', TPL_DOMAIN_LANG) : _e('Edit review', TPL_DOMAIN_LANG);
										?>
									</button>
								<?php endif; ?>
							</div>
							<div class="tutor-col-auto">
								<?php
									$pagination_data = array(
										...
										'layout'	  => array(
											'type' => 'load_more',
											'load_more_text' => __('Load More', TPL_DOMAIN_LANG)
										),
										'ajax'		  => array(
							...
							<div class="tutor-write-review-form" style="display: none;">
								<form method="post">
									<div class="tutor-star-rating-container">
										...
										<div class="tutor-form-group">
											<textarea name="review" placeholder="<?php _e('write a review', TPL_DOMAIN_LANG); ?>"><?php echo stripslashes($my_rating ? $my_rating->comment_content : ''); ?></textarea>
										</div>
										<div class="tutor-form-group">
											<button type="submit" class="tutor_submit_review_btn tutor-btn">
												<?php _e('Submit Review', TPL_DOMAIN_LANG); ?>
											</button>
										</div>
									</div>
								</form>
								...
								if ( $is_public ) {
									...
									?>
										<div class="text-regular-caption tutor-color-muted tutor-mt-12 ">
											...
											<?php esc_html_e( 'This course is public', TPL_DOMAIN_LANG); ?>
											</span>
										</div>
										<div class="pl-5 pr-5">										
										...
										<?php esc_html_e( 'Start Learning', TPL_DOMAIN_LANG); ?>
										</button>
										</a>
										</div>
									...
									?>
											...
											<?php
											if ( $course_price ) {
											esc_html_e( 'ADD TO CART', TPL_DOMAIN_LANG); 
											}
											else{
												esc_html_e( 'Enroll', TPL_DOMAIN_LANG); 
											}
											?>
											</button>
		...
		<div class=" tutor-align-items-center mt-4">
				<div class="tutor-fs-5 tutor-fw-bold mb-3">
					<?php _e('FREQUENTLY BOUGHT TOGETHER', TPL_DOMAIN_LANG); ?>
				</div>
				<div>
				<?php
