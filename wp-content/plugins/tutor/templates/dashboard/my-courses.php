...
<form method="POST">
    <div class="tutor-course-listing-grid tutor-course-listing-grid-2">
        <div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-16">
            <?php esc_html_e('All Courses', TPL_DOMAIN_LANG); ?>
        </div>
        <div class="tutor-input-group tutor-form-control-has-icon tutor-from-control">
            ...
            <input id="keyword" type="Search" value="<?php echo $_POST['keyword']; ?>" class="tutor-form-control"
                name="keyword" placeholder="<?php _e('Search...', TPL_DOMAIN_LANG); ?>" />
        </div>
    ...
    <div class="tutor-course-listing-grid tutor-course-listing-grid-3">
        <div class="my-course-filters">
            <label class="tutor-form-label tutor-font-size-16">
                <?php
					_e('Filter by Categories', TPL_DOMAIN_LANG);
        ...
        <div class="my-course-filters">
            <label class="tutor-form-label tutor-font-size-16">
                <?php
					_e('Filter by Level', TPL_DOMAIN_LANG);
					?>
            </label>
            <div class="tutor-form-field-course-categories">
        ...
        <div class="my-course-filters">
            <label class="tutor-form-label tutor-font-size-16">
                <?php
					_e('Filter by Price', TPL_DOMAIN_LANG);
					?>
            </label>
            <div class="tutor-form-field-course-categories">
                <select name="course-prices[]" multiple='multiple' class="tutor_select2" data-placeholder="">
                    <option value=""><?php __('Select a Price', TPL_DOMAIN_LANG) ?></option>;
                    <?php
    ...
    <div class="tutor-course-listing-grid tutor-course-listing-grid-3 mt-2">
        <div class="my-course-filters">
            <label class="tutor-form-label tutor-font-size-16">
                <?php
					esc_html_e('Sort By', TPL_DOMAIN_LANG);
				?>
            </label>
            <div class="tutor-form-field-sort_by">
                <select name="sort_by" class="tutor-form-field-sort">\
                    <option value="date" <?php if ($_POST['sort_by'] != "title") echo "selected"; ?>>
                        <?php esc_html_e('Date', TPL_DOMAIN_LANG); ?></option>
                    <option value="title" <?php if ($_POST['sort_by'] == "title") echo "selected"; ?>>
                        <?php esc_html_e('Title', TPL_DOMAIN_LANG); ?></option>
                </select>
            </div>
        </div>
        <div class="my-course-filters">
            ...
            <div class="tutor-form-field-sort_type">
                <select name="sort_type" class="tutor-form-field-sort">
                    <option value="ASC" <?php if ($_POST['sort_type'] == "ASC") echo "selected"; ?>>
                        <?php esc_html_e('ascending', TPL_DOMAIN_LANG); ?></option>
                    <option value="DESC" <?php if ($_POST['sort_type'] != "ASC") echo "selected"; ?>>
                        <?php esc_html_e('descending', TPL_DOMAIN_LANG); ?></option>
                </select>
            </div>
        </div>
        <div class="my-course-filters mt-4">
            <button class="tutor-btn tutor-btn-primary tutor-btn-sm tutor-ml-16" type="submit"
                name="course_submit_filter" value="Submit">
                Submit</button>
            <button class="tutor-btn tutor-btn-primary tutor-btn-sm tutor-ml-16" type="reset" id="course_reset_filter"
                value="Reset">
                Reset</button>
        </div>
    </div>
        ...
        <ul>
            <li class="<?php echo $active_tab == 'my-courses' ? 'active' : ''; ?>">
                <a href="<?php echo esc_url(tutor_utils()->get_tutor_dashboard_page_permalink('my-courses')); ?>">
                    <?php esc_html_e('Publish', TPL_DOMAIN_LANG); ?>
                </a>
            </li>
            <li class="<?php echo $active_tab == 'my-courses/pending-courses' ? 'active' : ''; ?>">
                <a
                    ...
                    <?php esc_html_e('Pending', TPL_DOMAIN_LANG); ?>
                </a>
            </li>
            <li class="<?php echo $active_tab == 'my-courses/draft-courses' ? 'active' : ''; ?>">
                <a
                    ...
                    <?php esc_html_e('Draft', TPL_DOMAIN_LANG); ?>
                </a>
            </li>
            <li class="<?php echo $active_tab == 'my-courses/private-courses' ? 'active' : ''; ?>">
                <a
                    href="<?php echo esc_url(tutor_utils()->get_tutor_dashboard_page_permalink('my-courses/private-courses')); ?>">
                    <?php esc_html_e('Private', TPL_DOMAIN_LANG); ?>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="tutor-course-listing-grid tutor-course-listing-grid-3">
        <?php
			...
			while (have_posts()) :
				...
				$currentTimeVietnam = date('H:i:s');
				// echo '<pre>';
				// echo $currentTimeVietnam;
        		// var_dump(get_post_meta(get_the_ID())["_tutor_course_start_time"]);
        		// var_dump(get_post_meta(get_the_ID())["_tutor_course_end_time"]);
        		// echo '</pre>';
			?>

        <div id="<?php echo $row_id; ?>"
            class="tutor-course-listing-item tutor-course-listing-item-sm tutor-mycourses-card tutor-mycourse-<?php the_ID(); ?>">
            <div class="tutor-course-listing-item-head tutor-d-flex">
                <!-- <img src="<?php //echo esc_url($tutor_course_img); 
										?>" alt="Course Thumbnail"> -->
                <div class="tutor-course-listing-thumbnail"
                    style="background-image:url(<?php echo empty(esc_url($tutor_course_img)) ? $placeholder_img : esc_url($tutor_course_img) ?>)">
                </div>
            </div>
            <div class="tutor-course-listing-item-body tutor-px-20 tutor-py-20">
                ...
                <div class="list-item-meta tutor-fs-7 tutor-fw-medium tutor-color-black tutor-d-flex tutor-mt-12">
                    ...
                    <div class="tutor-d-flex tutor-align-items-center">
                        <span
                            class="meta-icon tutor-icon-clock-filled tutor-color-muted tutor-icon-20 tutor-mr-3"></span>
                        <span
                            class="tutor-fs-7 tutor-fw-medium tutor-color-black"><?php echo $course_duration; ?></span>
                    </div>
                    <?php } ?>
            ...
            <div class="tutor-course-listing-item-footer has-border tutor-py-8 tutor-pl-20 tutor-pr-8">
                <div class="tutor-d-flex tutor-align-items-center tutor-justify-content-between">
                    ...
                    <div class="tutor-course-listing-item-btns">
                        <a href="<?php echo tutor_utils()->course_edit_link($post->ID); ?>"
                            class="tutor-btn tutor-btn-icon tutor-btn-disable-outline tutor-btn-ghost tutor-no-hover tutor-btn-sm">
                            <i class="tutor-icon-edit-filled tutor-icon-26 tutor-color-muted"></i>
                        </a>
                        <a href="#" data-tutor-modal-target="<?php echo $id_string_delete; ?>"
                            class="tutor-dashboard-element-delete-btn tutor-btn tutor-btn-icon tutor-btn-disable-outline tutor-btn-ghost tutor-no-hover tutor-btn-sm">
                        ...
                        <div class="tutor-modal-body tutor-text-center">
                            ...
                            <div class="tutor-modal-btns tutor-btn-group">
                                ...
                                <button class="tutor-btn tutor-list-ajax-action"
                                    data-request_data='{"course_id":<?php echo get_the_ID(); ?>,"action":"tutor_delete_dashboard_course"}'
