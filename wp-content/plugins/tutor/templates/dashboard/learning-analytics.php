...
<div class="tutor-d-flex tutor-gx-lg-4">
    <div class="tutor-col-lg-8 tutor-col-xl-8">
        <div class=" tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-16">
            <?php _e( 'OVERVIEW', TPL_DOMAIN_LANG ); ?>
        </div>
    </div>
    <div class="tutor-col-lg-4 tutor-col-xl-4 tutor-mb-16 tutor-mb-lg-16">
        <span class=" tutor-fs-6 tutor-fw-small tutor-color-black">
            <?php ( current_user_can( 'administrator' ) ) ? _e( 'All campuses / All learners', TPL_DOMAIN_LANG ):''; ?>
        </span>
    </div>
</div>
<div
    class="popular-courses-heading-dashboard tutor-fs-6 tutor-fw-medium tutor-color-black tutor-capitalize-text tutor-mb-24 tutor-mt-md-42 tutor-mt-0">
            ...
            <tr>
                <th class="tutor-table-rows-sorting">
                    <div class="inline-flex-center tutor-color-black-60">
                        <span class="text-regular-small"><?php esc_html_e( 'Course', TPL_DOMAIN_LANG ); ?></span>
                        <span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
                    </div>
                </th>
                <th class="tutor-table-rows-sorting">
                    <div class="inline-flex-center tutor-color-black-60">
                        <span class="text-regular-small"><?php esc_html_e( 'Enrollment', TPL_DOMAIN_LANG ); ?></span>
                        <span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
                    </div>
                </th>
                <th class="tutor-table-rows-sorting">
                    <div class="inline-flex-center tutor-color-black-60">
                        <span class="text-regular-small"><?php esc_html_e( 'Active', TPL_DOMAIN_LANG ); ?></span>
                        <span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
                    </div>
                </th>
                <th class="tutor-table-rows-sorting">
                    <div class="inline-flex-center tutor-color-black-60">
                        <span class="text-regular-small"><?php esc_html_e( 'Average Grade', TPL_DOMAIN_LANG ); ?></span>
                        <span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
                    </div>
                </th>
                <th class="tutor-table-rows-sorting">
                    <div class="inline-flex-center tutor-color-black-60">
                        <span class="text-regular-small"><?php esc_html_e( 'Average Pass Rate', TPL_DOMAIN_LANG ); ?></span>
                        <span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
                    </div>
                </th>
                <th class="tutor-table-rows-sorting">
                    <div class="inline-flex-center tutor-color-black-60">
                        <span class="text-regular-small"><?php esc_html_e( 'Passing Grade', TPL_DOMAIN_LANG ); ?></span>
                        <span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
                    </div>
                </th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                <td data-th="<?php esc_html_e( 'course', 'tutor' ); ?>">
                    <a
                        href="<?php echo tutor_utils()->get_tutor_dashboard_page_permalink( 'learning-analytics/detail' );?>?cid=<?php echo $course->ID;?>">
