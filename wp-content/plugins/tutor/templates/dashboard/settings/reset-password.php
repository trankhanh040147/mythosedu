	...
	<form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="tutor-row">
            <div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-7 tutor-mb-32">
                <label class="tutor-form-label tutor-color-black-60"> <?php esc_html_e('Current Password', TPL_DOMAIN_LANG); ?> </label>
                <input class="tutor-form-control" type="password" name="previous_password" placeholder="<?php esc_html_e('Current Password', TPL_DOMAIN_LANG); ?>">
            </div>
        </div>
				...
				<div class="tutor-password-strength-checker">
					<div class="tutor-password-field">
						<label class="field-label tutor-form-label" for="new-password-1">
							<?php esc_html_e( 'New Password', TPL_DOMAIN_LANG ); ?>
						</label>
						<div class="field-group">
							<input
								...
								type="password"
								name="new_password"
								placeholder="<?php esc_html_e( 'Type Password', TPL_DOMAIN_LANG ); ?>"
							/>
			...
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-7 tutor-mb-32">
				<div class="tutor-password-field tutor-settings-pass-field">
					<label class="field-label tutor-form-label" for="password-field-icon-1">
						<?php esc_html_e( 'Re-type New Password', TPL_DOMAIN_LANG ); ?>
					</label>
		...
		<div class="tutor-row">
			<div class="tutor-col-12">
				<button type="submit" class="tutor-btn tutor-profile-password-reset">
					<?php esc_html_e( 'Reset Password', TPL_DOMAIN_LANG ); ?>
				</button>
			</div>
		</div>
	</form>
