			...
			<div class="tutor-col-12 tutor-col-lg-9 tutor-mb-32 tutor-pr-32">
				...
				<div class="tutor-course-builder-section tutor-course-builder-info">
					...
					<div class="tutor-course-builder-section-content">
						...
						<div class="tutor-mb-32">
							<?php
								$tutor_course_start_time = get_post_meta($course_id, '_tutor_course_start_time', true);
							?>
							<label class="tutor-course-field-label tutor-font-size-16"><?php _e('Start Time', 'tutor'); ?></label>
							<div class="row mb-3">
								<div class="col-md-4">
									<input class="tutor-form-control tutor-mb-5" type="time" value="<?php echo $tutor_course_start_time;?>" name="_tutor_course_start_time">
									
								</div>
								<div class="col-md-8">
									<p class="tutor-fs-7 tutor-fw-normal tutor-has-icon tutor-color-muted tutor-d-flex tutor-mt-8">
										<i class="tutor-icon-info-circle-outline-filled tutor-input-feedback-icon tutor-font-size-19 tutor-mr-4" style="margin-top: 1px;"></i>
										<?php _e('Select the time when this course starts', 'tutor'); ?>
									</p>
						...
						<div class="tutor-mb-32">
							<?php
								$tutor_course_end_time = get_post_meta($course_id, '_tutor_course_end_time', true);
							?>
							<label class="tutor-course-field-label tutor-font-size-16"><?php _e('End Time', 'tutor'); ?></label>
							<div class="row mb-3">
								<div class="col-md-4">
									<input class="tutor-form-control tutor-mb-5" type="time" value="<?php echo $tutor_course_end_time;?>" name="_tutor_course_end_time">
									
								</div>
								<div class="col-md-8">
									<p class="tutor-fs-7 tutor-fw-normal tutor-has-icon tutor-color-muted tutor-d-flex tutor-mt-8">
										<i class="tutor-icon-info-circle-outline-filled tutor-input-feedback-icon tutor-font-size-19 tutor-mr-4" style="margin-top: 1px;"></i>
										<?php _e('Select the time when this course end', 'tutor'); ?>
									</p>
