...
<div class="tutor-dashboard-content-inner">
	<div class="tutor-row tutor-gx-lg-4" >
		...
		<select class="tutor-form-select tutor-select-redirector">
			<option value="./?cid=&st=<?php echo $st;?>"><?php _e( 'Please select a course', TPL_DOMAIN_LANG ); ?></option>
                <?php
		...
		<select class="tutor-form-select tutor-select-redirector">
			<option value="./?cid=<?php echo $active_cid;?>&st="><?php _e( 'Status', TPL_DOMAIN_LANG ); ?></option>
                <?php
...
if($active_cid){
	...
	?>
		<div class="popular-courses-heading-dashboard tutor-fs-6 tutor-fw-medium tutor-color-design-brand tutor-capitalize-text tutor-mt-24 tutor-mb-24 qs-progress">
			<center><?php esc_html_e( 'Passing Grade:', TPL_DOMAIN_LANG ); ?><?php echo $GPA;?>%</center>
		</div>
<?php		
}
					...
					<tr>
						<th class="tutor-table-rows-sorting">
							<div class="inline-flex-center tutor-color-black-60">
								<span class="text-regular-small"><?php esc_html_e( 'Student', TPL_DOMAIN_LANG ); ?></span>
								<span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
							</div>
						</th>
						<th class="tutor-table-rows-sorting">
							<div class="inline-flex-center tutor-color-black-60">
								<span class="text-regular-small"><?php esc_html_e( 'Enrolled At', TPL_DOMAIN_LANG ); ?></span>
								<span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
							</div>
						</th>
						<th class="tutor-table-rows-sorting">
							<div class="inline-flex-center tutor-color-black-60">
								<span class="text-regular-small"><?php esc_html_e( 'Earned Marks', TPL_DOMAIN_LANG ); ?></span>
								<span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
							</div>
						</th>
						<th class="tutor-table-rows-sorting">
							<div class="inline-flex-center tutor-color-black-60">
								<span class="text-regular-small"><?php esc_html_e( 'Status', TPL_DOMAIN_LANG ); ?></span>
								<span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
							</div>
						</th>
						<th class="tutor-table-rows-sorting">
							<div class="inline-flex-center tutor-color-black-60">
								<span class="text-regular-small"><?php esc_html_e( 'Completed At', TPL_DOMAIN_LANG ); ?></span>
								<span class="tutor-icon-ordering-a-to-z-filled a-to-z-sort-icon tutor-icon-22"></span>
							</div>
						</th>
					</tr>
				...
				<tbody>
					<?php if ( is_array($students_all) && count($students_all) ) : ?>
						...
						foreach ( $students_all as $student ) :
							...
							?>
							<tr>
								<td data-th="<?php esc_html_e( 'Student', TPL_DOMAIN_LANG ); ?>">
									<span class="tutor-fs-7 tutor-fw-medium tutor-color-black">
										<?php esc_html_e( $student['user_email'] ); ?>
									</span>
								</td>
								<td data-th="<?php esc_html_e( 'Enrolled At', TPL_DOMAIN_LANG ); ?>">
									<span class="tutor-fs-7 tutor-fw-medium tutor-color-black">
										<?php esc_html_e( $student['enrolled_at'] ); ?>
									</span>
								</td>
								<td data-th="<?php esc_html_e( 'Earned Marks', TPL_DOMAIN_LANG ); ?>">
									<div class="td-tutor-rating tutor-fs-6 tutor-fw-normal tutor-color-black-60">
										<?php esc_html_e( $completed_percent); ?>%
									</div>
								</td>
								<td data-th="<?php esc_html_e( 'Status', TPL_DOMAIN_LANG ); ?>">
									<div class="td-tutor-rating tutor-fs-6 tutor-fw-normal tutor-color-black-60">
										<?php  echo $status;?>
									</div>
								</td>
								<td data-th="<?php esc_html_e( 'Completed At', TPL_DOMAIN_LANG ); ?>">
									<span class="tutor-fs-7 tutor-fw-medium tutor-color-black">
