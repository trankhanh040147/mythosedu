            ...
            <div class="tutor-form-col-6">
                <div class="tutor-form-group">
                    ...
                    */
                    ...
                    <input type="text" name="first_name" value="<?php esc_attr_e(tutor_utils()->input_old('first_name')) ; ?>" placeholder="<?php _e('Full Name', 'tutor'); ?>" required autocomplete="given-name">
                </div>
            </div>
            ...
            <div class="tutor-form-col-6">
                ...
                <?php
                    ...
                    */
                    ...
                    <input type="hidden" name="last_name" value="<?php esc_attr_e(tutor_utils()->input_old('last_name')); ?>" placeholder="<?php _e('Last Name', 'tutor'); ?>" required autocomplete="family-name">
                </div>
            </div>
        ...
        <div class="tutor-form-row">
            <div class="tutor-form-col-12">
                <div class="tutor-form-group tutor-reg-form-btn-wrap">
                    <button type="submit" name="tutor_register_student_btn" value="register" class="tutor-btn _btn_red"><?php _e('Sign Up', 'tutor'); ?></button>
                </div>
                <p >Already have a account? <a href="/my-account">Log in</a> </p>
            </div>
        </div>
