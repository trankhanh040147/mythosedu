		...
		?>
			<div class="filter-widget-search">
				<div class="tutor-input-group tutor-form-control-has-icon tutor-from-control">
					...
					<input type="Search" class="tutor-form-control" name="keyword" placeholder="<?php _e( 'Search...', TPL_DOMAIN_LANG); ?>"/>
				</div>
			</div>
			<?php
	}
	...
	<div class="tutor-filter-widget-items-wrap">
		<div class="filter-widget-input-wrapper tutor-mt-24">
			<div class="filter-widget-input">
				...
				<div class="filter-widget-title tutor-fs-6 tutor-fw-normal tutor-color-black tutor-mb-24">
					<?php esc_html_e( 'Categories', TPL_DOMAIN_LANG ); ?>
				</div>
		...
		*/
		...
		<div class="filter-widget-input-wrapper tutor-mt-24">
			<div class="filter-widget-input">
				<div class="filter-widget-title tutor-fs-6 tutor-fw-normal tutor-color-black tutor-mb-24">
				<?php esc_html_e( 'Level', TPL_DOMAIN_LANG ); ?>
				</div>
				<div class="filter-widget-checkboxes">
				<?php
					$key = '';
				foreach ( $course_levels as  $value => $title ) {
					...
					?>
						<div class="tutor-form-check tutor-mb-20">
							...
							<?php esc_html_e( $title,TPL_DOMAIN_LANG ); ?>
							</label>
						</div>
					<?php } ?>
				</div>
			...
			<div class="filter-widget-input">
				<div class="tutor-clear-all-filter">
					<a href="#" onclick="window.location.reload()">
						<i class="tutor-icon-cross-filled"></i> <?php esc_html_e( 'Clear All Filters', TPL_DOMAIN_LANG ); ?>
					</a>
				</div>
			</div>
		</div>
