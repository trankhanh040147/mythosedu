            ...
            <div class="tutor-course-details-page-main-left">
                <div class="tutor-container __course_info_top">
							...
							<span>
								...
								if (is_array($course_categories) && count($course_categories)) {
									foreach ($course_categories as $course_category) {
										...
										$cats_array[] = "<a href='$category_link'>"._e($category_name, TPL_DOMAIN_LANG )."</a>";
									}
					...
					<div class="tutor-course-author tutor-mr-16">
						<div><?php _e('Speaker: ', TPL_DOMAIN_LANG); ?></div>
				...
				<?php                 
						...
						<div class="tutor-course-details-widget tutor-course-details-widget-col-1 tutor-mt-lg-50 tutor-mt-32">
							<div class="tutor-course-details-widget-title tutor-mb-16">
								<span class="tutor-fs-5 tutor-fw-bold mb-3">
									<?php echo esc_html( apply_filters( 'tutor_course_benefit_title', __( "WHAT YOU'LL LEARN", TPL_DOMAIN_LANG ) ) ); ?>
								</span>
							</div>
					...
					<div class="tutor-course-details-widget tutor-course-details-widget-col-1 tutor-mt-lg-50 tutor-mt-32">
						<div class="tutor-course-details-widget-title tutor-mb-16">
							<span class="tutor-fs-5 tutor-fw-bold mb-3">
								<?php echo esc_html( apply_filters( 'tutor_course_benefit_title', __( "COURSE CONTENT", TPL_DOMAIN_LANG ) ) ); ?>
							</span>
						</div>
						<div>
							<?php
							...
							<span class="">
								<?php
									echo __( "sections", TPL_DOMAIN_LANG );	
								?>
							</span>
							...
							<span class="">
								<?php
									echo __( "lessons", TPL_DOMAIN_LANG );	
								?>
							</span>
					...
					<?php if(time() >= strtotime($tutor_course_start_date)): ?>					
					<div class="tutor-course-details-widget tutor-course-details-widget-col-1 tutor-mt-lg-50 tutor-mt-32">
						...
						<div>
							...
							if ( is_array( $attachments ) && count( $attachments ) ) {
								...
								<div class="tutor-course-details-widget-title tutor-mb-16">
									<span class="tutor-fs-5 tutor-fw-bold mb-3">
										<?php echo esc_html( apply_filters( 'tutor_course_attachments_title', __( "DOCUMENTS", TPL_DOMAIN_LANG ) ) ); ?>
									</span>
								</div>
					...
					<div class="tutor-pagination-wrapper-replacable">
						<div class="tutor-course-topics-header">
							<div class="tutor-course-topics-header-left tutor-mb-20">
								<div class="tutor-fs-5 tutor-fw-bold mb-3 mt-3">
									<span>
										<?php
											$review_title = apply_filters( 'tutor_course_reviews_section_title', _e('FEEDBACK',TPL_DOMAIN_LANG ) );
						...
						<?php if(! is_array( $reviews ) || ! count( $reviews )): ?>
							<?php tutor_utils()->tutor_empty_state(__('No Review Yet', TPL_DOMAIN_LANG)); ?>
						<?php else: ?>
                ...
                <div class="tutor-single-course-sidebar">
                    ...
                    <div class="tutor-course-sidebar-card">
						...
						if($vus_member=="Internal"){	//if internal member
							$course_type = get_post_meta( get_the_ID(), '_tutor_course_type', true);
						...
						<div class="text-regular-body tutor-color-black-60 tutor-d-flex tutor-align-items-center tutor-justify-content-between">
							<div class="course-right-price">
                                <?php 
									if(!$course_price)
										echo  esc_html_e( 'Free',TPL_DOMAIN_LANG  );
									else
						...
						<div class=" text-regular-body tutor-color-black-60 tutor-d-flex tutor-align-items-center">
							...
							<div class="_courses_durations_ tutor-d-flex tutor-align-items-center course_lesson_duration">
								...
								<?php echo  esc_html_e( 'LECTURES',TPL_DOMAIN_LANG  ); ?>
                            </div>
						...
						<div class="addtocart_grp text-regular-body tutor-color-black-60 tutor-d-flex tutor-align-items-center tutor-justify-content-between">
						<?php
						...
						if ( $is_public ) {
							...
							?>
								<div class="container-fluid text-regular-caption tutor-color-muted tutor-mt-12 ">
						...
						elseif($course_enrolled){	// if course enrolled
							...
							if($is_completed_course){	
							 ...
							 <div class="text-regular-caption tutor-color-muted tutor-mt-12 tutor-d-flex">
									...
									if (!empty($courses_in_progress) && count($courses_in_progress) ) :?>
									<?php
									global $post;									
									foreach ($courses_in_progress as $post) :
									setup_postdata($post);
										$sub_class = 0;//echo $post->rowadd;echo $rowadd;
										if(($post->rowadd) && ($post->rowadd == $rowadd)) {
											if($rowadd) $sub_class = 1;
											
										}
										$rowadd = $post->rowadd;
										//echo $sub_class;
										if($post->countsub && $post->firstchild==$course_id_current){
											$can_learn = true;//echo $post->firstchild;
											break;
										}
										if(!$post->countsub && !$sub_class && $post->ID==$course_id_current){
											$can_learn = true;//echo $post->firstsub;
											//echo $post->ID;
											break;
										}
									endforeach;
						...
						elseif ( $course_price ) {
							if($product_id){
							?>
								<a href="/dashboard/?add-to-cart=<?php echo $product_id;?>">	
								<button type="submit" class="add_to_cart_btn tutor-mt-16 tutor-btn tutor-btn-tertiary tutor-is-outline tutor-btn-lg tutor-btn-full" name="complete_course_btn" value="complete_course">
							...
							if(current_user_can('subscriber')||current_user_can('st_lt')){
							?>
							...
							?>
								...
								<div class="text-regular-caption tutor-color-muted tutor-mt-12 tutor-d-flex">
										<a href="<?php echo $lesson_url;?>">
										<button type="submit" class="tutor-btn add_to_cart_btn tutor-btn-primary tutor-btn-lg tutor-btn-full tutor-mt-16 tutor-enroll-course-button">
										<?php esc_html_e( 'Preview', TPL_DOMAIN_LANG ); ?>
										</button>
										</a>
							<?php	
							}							
