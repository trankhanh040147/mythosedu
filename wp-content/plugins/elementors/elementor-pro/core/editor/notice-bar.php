		...
		if ( License_API::is_license_active() || License_API::STATUS_EXPIRED === $license_data['license'] ) {
			if ( License_API::STATUS_EXPIRED === $license_data['license'] || License_API::is_license_about_to_expire() ) {
				$settings = [
					...
					'message' => __( 'Renew Drag & Drop Layout Pro and enjoy updates, support and Pro templates for another year.', 'elementor-pro' ),
			...
			$settings = [
				...
				'message' => __( 'Activate Your License and Get Access to Premium Drag & Drop Layout Templates, Support & Plugin Updates.', 'elementor-pro' ),
