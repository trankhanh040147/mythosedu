...
use Elementor\Utils;
use \ElementorPro\Core\Admin\Component;
...
class Plugin {
	...
	public function on_elementor_init() {
		...
		/** TODO: BC for Drag & Drop Layout v2.4.0 */
		if ( class_exists( '\Elementor\Core\Upgrade\Manager' ) ) {
			$this->upgrade = UpgradeManager::instance();
		}

		/**
		 * Drag & Drop Layout Pro init.
		 *
		 * Fires on Drag & Drop Layout Pro init, after Drag & Drop Layout has finished loading but
	...
	final public static function get_title() {
		return __( 'Drag & Drop Layout Pro', 'elementor-pro' );
	}
}
