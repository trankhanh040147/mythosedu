...
class Form_Record {
	...
	public function validate( $ajax_handler ) {
		foreach ( $this->fields as $id => $field ) {
			...
			/**
			 * Drag & Drop Layout form field validation.
			 *
		...
		/**
		 * Drag & Drop Layout form validation.
		 *
	...
	public function process_fields( $ajax_handler ) {
		foreach ( $this->fields as $id => $field ) {
			...
			/**
			 * Drag & Drop Layout form field process.
			 *
			...
			switch ( $metadata_type ) {
				...
				case 'credit':
					$this->meta['credit'] = [
						...
						'value' => __( 'Drag & Drop Layout', 'elementor-pro' ),
					];
					break;
			}
		}
