		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					PageTemplatesModule::TEMPLATE_CANVAS => __( 'Drag & Drop Layout Canvas', 'elementor-pro' ),
					PageTemplatesModule::TEMPLATE_HEADER_FOOTER => __( 'Drag & Drop Layout Full Width', 'elementor-pro' ),
				],
			]
		);
