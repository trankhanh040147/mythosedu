...
class Single extends Theme_Page_Document {
	...
	public function preview_error_handler() {
		...
		wp_localize_script( 'elementor-frontend', 'elementorPreviewErrorArgs', [
			...
			'message' => sprintf( __( 'You must include the %1$s Widget in your template (%2$s), in order for Drag & Drop Layout to work on this page.', 'elementor-pro' ), $depended_widget_title, '<strong>' . static::get_title() . '</strong>' ),
			'strings' => [
