...
/**
 * Drag & Drop Layout modules manager.
 *
 * Drag & Drop Layout modules manager handler class is responsible for registering and
 * managing Drag & Drop Layout modules.
 *
 * @since 1.6.0
 */
class Modules_Manager {
	 ...
	 *
	 * Initializing the Drag & Drop Layout modules manager.
	 *
	 * @since 1.6.0
	 * @access public
	 */
