...
/**
 * Drag & Drop Layout general settings manager.
 *
 * Drag & Drop Layout general settings manager handler class is responsible for registering
 * and managing Drag & Drop Layout general settings managers.
 *
 * @since 1.6.0
 */
class Manager extends CSS_Manager {
	 ...
	 *
	 * Initializing Drag & Drop Layout general settings manager.
	 *
	 * @since 1.6.0
	 * @access public
	 */
