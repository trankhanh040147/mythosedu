...
/**
 * Drag & Drop Layout ajax manager.
 *
 * Drag & Drop Layout ajax manager handler class is responsible for handling Elementor
...
class Module extends BaseModule {
	 ...
	 *
	 * Initializing Drag & Drop Layout ajax manager.
	 *
	 * @since 2.0.0
	 * @access public
	 */
	 ...
	 * give the user an access to Drag & Drop Layout ajax actions.
	 *
	 * @since 2.3.0
	 * @access public
	 *
