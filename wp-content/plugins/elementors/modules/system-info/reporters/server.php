...
/**
 * Drag & Drop Layout server environment report.
 *
 * Drag & Drop Layout system report handler class responsible for generating a report for
...
class Server extends Base {
	...
	public function get_fields() {
		return [
			...
			'elementor_library' => 'Drag & Drop Layout Library',
		];
	}
	...
	public function get_write_permissions() {
		...
		if ( is_dir( $elementor_uploads_path ) ) {
			$paths_to_check[ $elementor_uploads_path ] = 'Drag & Drop Layout uploads directory';
		}
