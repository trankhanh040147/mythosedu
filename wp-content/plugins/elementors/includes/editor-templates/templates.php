...
<script type="text/template" id="tmpl-elementor-template-library-get-pro-button">
	<a class="elementor-template-library-template-action elementor-button elementor-go-pro" href="<?php echo Utils::get_pro_link( '#' ); ?>" target="_blank">
...
<script type="text/template" id="tmpl-elementor-template-library-save-template">
	...
	<div class="elementor-template-library-blank-footer">
		...
		<a class="elementor-template-library-blank-footer-link" href="#" target="_blank"><?php echo __( 'Click here', 'elementor' ); ?></a>
	</div>
</script>
