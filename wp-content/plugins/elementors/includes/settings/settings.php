	...
	public function elementor_custom_fonts() {
		...
		<div class="wrap">
			<div class="elementor-blank_state">
				...
				<a class="elementor-button elementor-button-default elementor-button-go-pro" target="_blank" href="<?php echo Utils::get_pro_link( '#' ); ?>"><?php echo __( 'Go Pro', 'elementor' ); ?></a>
			</div>
		</div><!-- /.wrap -->
		<?php
	}
