...
/**
 * Drag & Drop Layout template library manager.
 *
 * Drag & Drop Layout template library manager handler class is responsible for
...
class Manager {
	 ...
	 *
	 * Register the 'local' and 'remote' template sources that Drag & Drop Layout use by
	 * default.
	 *
	 * @since 1.0.0
	 * @access private
	...
	private function handle_direct_action_error( $message ) {
		_default_wp_die_handler( $message, 'Drag & Drop Layout Library' );
	}
