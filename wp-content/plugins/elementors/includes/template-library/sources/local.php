	...
	public function admin_import_template_form() {
		...
		<div id="elementor-hidden-area">
			...
			<div id="elementor-import-template-area">
				<div id="elementor-import-template-title"><?php echo __( 'Choose an Drag & Drop Layout template JSON file or a .zip archive of Drag & Drop Layout templates, and add them to the list of templates available in your library.', 'elementor' ); ?></div>
	...
	public function maybe_render_blank_state( $which ) {
		...
		<div class="elementor-template_library-blank_state">
			<div class="elementor-blank_state">
				...
				<a id="elementor-template-library-add-new" class="elementor-button elementor-button-success" href="<?php esc_url( Utils::get_pro_link( '#' ) ); ?>">
					<?php
					/* translators: %s: Template type label. */
