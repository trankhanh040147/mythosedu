...
/**
 * Drag & Drop Layout API.
 *
 * Drag & Drop Layout API handler class is responsible for communicating with Elementor
...
class Api {
	...
	/**
	 * Drag & Drop Layout library option key.
	 */
	const LIBRARY_OPTION_KEY = 'elementor_remote_info_library';

	/**
	 * Drag & Drop Layout feed option key.
	 */
	 ...
	 */
	private static $api_feedback_url = '#';
	 ...
	 * Send Feedback.
	 *
	 * Fires a request to Drag & Drop Layout server with the feedback data.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 ...
	 * Ajax reset API data.
	 *
	 * Reset Drag & Drop Layout library API data using an ajax call.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 ...
	 * Init.
	 *
	 * Initialize Drag & Drop Layout API.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
