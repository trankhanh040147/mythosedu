...
/**
 * Drag & Drop Layout database.
 *
 * Drag & Drop Layout database handler class is responsible for communicating with the
 * DB, save and retrieve Drag & Drop Layout data and meta data.
 *
 * @since 1.0.0
 */
class DB {
	 ...
	 *
	 * When editing the with Drag & Drop Layout the first time, the current page content
	 ...
	 * @param int $post_id Post ID.
	 *
	 * @return array Content in Drag & Drop Layout format.
	 */
	 ...
	 * Is using Elementor.
	 *
	 * Set whether the page is using Drag & Drop Layout or not.
	 *
	 * @since 1.5.0
	 * @access public
	 *
	 ...
	 * Iterate data.
	 *
	 * Accept any type of Drag & Drop Layout data and a callback function. The callback
	...
	/**
	 * Safely copy Drag & Drop Layout meta.
	 *
	 * Make sure the original page was built with Drag & Drop Layout and the post is not
	...
	public function safe_copy_elementor_meta( $from_post_id, $to_post_id ) {
		...
		if ( ! did_action( 'elementor/db/before_save' ) ) {
			...
			// It's an exited Drag & Drop Layout auto-save
	 ...
	 *
	 * Retrieve the post plain text from any given Drag & Drop Layout data.
	 *
	 * @since 1.9.2
	 * @access public
	 *
