...
/**
 * Drag & Drop Layout compatibility.
 *
 * Drag & Drop Layout compatibility handler class is responsible for compatibility with
...
class Compatibility {
	 ...
	 * Register actions.
	 *
	 * Run Drag & Drop Layout compatibility with external plugins using custom filters and
	 * actions.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 * using Drag & Drop Layout page builder.
	 *
	 * @since 1.9.0
	 * @access public
	 * @static
	 ...
	 * Init.
	 *
	 * Initialize Drag & Drop Layout compatibility with external plugins.
	 *
	 ...
	 *
	 * Normalize Drag & Drop Layout post meta on import, We need the `wp_slash` in order
	 ...
	 *
	 * Normalize Drag & Drop Layout post meta on import with the new WP_importer, We need
