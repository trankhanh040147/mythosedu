...
/**
 * Drag & Drop Layout user.
 *
 * Drag & Drop Layout user handler class is responsible for checking if the user can edit
 * with Drag & Drop Layout and displaying different admin notices.
 *
 * @since 1.0.0
 */
class User {
	 ...
	 * Init.
	 *
	 * Initialize Drag & Drop Layout user.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 ...
	 *
	 * Whether the current user role is not excluded by Drag & Drop Layout Settings.
	 *
	 * @since 2.1.7
	 * @access public
	 * @static
