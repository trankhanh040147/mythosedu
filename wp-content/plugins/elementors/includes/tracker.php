...
/**
 * Drag & Drop Layout tracker.
 *
 * Drag & Drop Layout tracker handler class is responsible for sending non-sensitive plugin
 * data to Drag & Drop Layout servers for users that actively allowed data tracking.
 *
 * @since 1.0.0
 */
class Tracker {
	 ...
	 * Init.
	 *
	 * Initialize Drag & Drop Layout tracker.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 ...
	 * @static
	 *
	 * @return array The number of posts using Drag & Drop Layout grouped by post types
	 *               and post status.
	 */
	 ...
	 * Get library usage.
	 *
	 * Retrieve the number of Drag & Drop Layout library items saved.
	 *
	 * @since 2.0.0
	 * @access public
	 * @static
	 *
	 * @return array The number of Drag & Drop Layout library items grouped by post types
	 *               and meta value.
	 */
