...
/**
 * Drag & Drop Layout beta testers.
 *
 * Drag & Drop Layout beta testers handler class is responsible for the Beta Testers
 * feature that allows developers to test Drag & Drop Layout beta versions.
 *
 * @since 1.5.0
 */
class Beta_Testers {

	const NEWSLETTER_TERMS_URL = '#';

	const NEWSLETTER_PRIVACY_URL = '#';
	 ...
	 * Transient key.
	 *
	 * Holds the Drag & Drop Layout beta testers transient key.
	 *
	 * @since 1.5.0
	 * @access private
	 * @static
	 ...
	 * Get beta version.
	 *
	 * Retrieve Drag & Drop Layout beta version from wp.org plugin repository.
	 *
	 * @since 1.5.0
	 * @access private
	 *
	 ...
	 *
	 * Initializing Drag & Drop Layout beta testers.
	 *
	 * @since 1.5.0
	 * @access public
	 */
