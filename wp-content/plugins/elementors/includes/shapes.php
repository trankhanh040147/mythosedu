...
/**
 * Drag & Drop Layout shapes.
 *
 * Drag & Drop Layout shapes handler class is responsible for setting up the supported
 * shape dividers.
 *
 * @since 1.3.0
 */
class Shapes {
	...
	private static function get_additional_shapes() {
		 ...
		 * Additional shapes.
		 *
		 * Filters the shapes used by Drag & Drop Layout to add additional shapes.
		 *
		 * @since 2.0.1
		 *
		 * @param array $additional_shapes Additional Drag & Drop Layout shapes.
		 */
