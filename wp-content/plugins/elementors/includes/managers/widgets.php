...
/**
 * Drag & Drop Layout widgets manager.
 *
 * Drag & Drop Layout widgets manager handler class is responsible for registering and
 * initializing all the supported Drag & Drop Layout widgets.
 *
 * @since 1.0.0
 */
class Widgets_Manager {
	 ...
	 * Init widgets.
	 *
	 * Initialize Drag & Drop Layout widgets manager. Include all the the widgets files
	 * and register each Drag & Drop Layout and WordPress widget.
	 *
	 * @since 2.0.0
	 * @access private
	*/
	private function init_widgets() {
		 ...
		 *
		 * Fires after Drag & Drop Layout widgets are registered.
		 *
		 * @since 1.0.0
		 *
	 ...
	 *
	 * Exclude the widgets that are in Drag & Drop Layout widgets black list. Theme and
	...
	*/
	private function register_wp_widgets() {
		...
		/**
		 * Drag & Drop Layout widgets black list.
		 *
	 ...
	 * Require files.
	 *
	 * Require Drag & Drop Layout widget base class.
	 *
	 * @since 2.0.0
	 * @access private
	*/
	 ...
	 * @access public
	 *
	 * @param Widget_Base $widget Drag & Drop Layout widget.
	 *
	...
	*/
	 ...
	 * Ajax render widget.
	 *
	 * Ajax handler for Drag & Drop Layout render_widget.
	 *
	 ...
	 *
	 * Ajax handler for Drag & Drop Layout editor get_wp_widget_form.
	 *
	...
	*/
	 ...
	 *
	 * Initializing Drag & Drop Layout widgets manager.
	 *
	 * @since 1.0.0
	 * @access public
	*/
