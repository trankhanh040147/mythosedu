...
/**
 * Drag & Drop Layout utils.
 *
 * Drag & Drop Layout utils handler class is responsible for different utility methods
 * used by Elementor.
 *
 * @since 1.0.0
 */
class Utils {
	 ...
	 * Get edit link.
	 *
	 * Retrieve Drag & Drop Layout edit link.
	 *
	 * @since 1.0.0
	...
	public static function get_edit_link( $post_id = 0 ) {
		 ...
		 * Get edit link.
		 *
		 * Filters the Drag & Drop Layout edit link.
		 *
		 * @since 1.0.0
	 ...
	 * Get pro link.
	 *
	 * Retrieve the link to Drag & Drop Layout Pro.
	 *
	 * @since 1.7.0
	 * @access public
	 * @static
	 *
	 * @param string $link URL to Drag & Drop Layout pro.
	 *
	 * @return string Drag & Drop Layout pro link.
	 */
	...
	public static function get_preview_url( $post_id ) {
		 ...
		 * Preview URL.
		 *
		 * Filters the Drag & Drop Layout preview URL.
		 *
		 * @since 1.6.4
	 ...
	 * Replace URLs.
	 *
	 * Replace old URLs to new URLs. This method also updates all the Drag & Drop Layout data.
	 *
	 * @since 2.1.0
	 * @static
	 * @access public
	...
	/**
	 * Add Drag & Drop Layout Config js vars to the relevant script handle,
