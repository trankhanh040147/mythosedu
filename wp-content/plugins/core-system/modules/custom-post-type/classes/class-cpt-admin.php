...
class cpt_admin_ui {
	...
	public function get_help( $help_text = '' ) {
		return '<a href="#" class="cpt-help dashicons-before dashicons-editor-help" title="' . esc_attr( $help_text ) . '"></a>';
	}
	...
	public function get_description( $help_text = '' ) {
		return '<p class="cpt-field-description description">' . $help_text . '</p>';
	}
