...
<div id="wf-toupp-required-message">
	<div id="wf-toupp-required-message-inner">
		...
		<p><a href="#" class="wf-btn wf-btn-default" onclick="window.location = jQuery('#wf-onboarding-resume').attr('href'); return false;"><?php esc_html_e('Resume Installation', 'wordfence'); ?></a></p>
	</div>
</div>
