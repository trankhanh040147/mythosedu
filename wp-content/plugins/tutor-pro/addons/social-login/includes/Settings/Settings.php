		...
		$twitter = array(
			...
			'fields'     => array(
				...
				array(
					...
					'desc'        => __( 'Enter your <a href="https://docs.themeum.com/tutor-lms/tutorials/" target="_blank">Twitter App Key</a> here.', 'tutor-pro' ),
				...
				array(
					...
					'desc'        => __( 'Enter your <a href="https://docs.themeum.com/tutor-lms/tutorials/" target="_blank">Twitter App Key Secret</a> here.' . $twitter_copy_btn, 'tutor-pro' ),
