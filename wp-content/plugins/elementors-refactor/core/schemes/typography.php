...
/**
 * Drag & Drop Layout typography scheme.
 *
 * Drag & Drop Layout typography scheme class is responsible for initializing a scheme
 * for typography.
 *
 * @since 1.0.0
 */
class Typography extends Base_UI {
	...
	public function print_template_content() {
		?>
		<div class="co-panel-scheme-items"></div>
		<?php
	}
}
