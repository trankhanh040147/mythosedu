...
abstract class Base_UI extends Base {
	...
	final public function print_template() {
		?>
		<script type="text/template" id="tmpl-co-panel-schemes-<?php echo static::get_type(); ?>">
			<div class="co-panel-scheme-buttons">
				<div class="co-panel-scheme-button-wrapper co-panel-scheme-reset">
					<button class="co-button">
				...
				<div class="co-panel-scheme-button-wrapper co-panel-scheme-save">
					<button class="co-button co-button-success" disabled><?php echo __( 'Apply', 'elementor' ); ?></button>
				</div>
			</div>
