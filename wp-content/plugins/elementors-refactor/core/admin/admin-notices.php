...
class Admin_Notices extends Module {
	...
	private function notice_api_upgrade_plugin() {
		...
		?>
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				<div class="co-message-icon">
				...
				<div class="co-message-content">
					...
					<p>
						...
						printf(
							...
							__( 'There is a new version of Drag & Drop Layout Page Builder available. <a href="%1$s" class="thickbox open-plugin-details-modal" aria-label="%2$s">View version %3$s details</a> or <a href="%4$s" class="update-link" aria-label="%5$s">update now</a>.', 'elementor' ),
							esc_url( $details_url ),
							esc_attr( sprintf(
								/* translators: %s: Drag & Drop Layout version */
								__( 'View Drag & Drop Layout version %s details', 'elementor' ),
								$new_version
							) ),
							$new_version,
							esc_url( $upgrade_url ),
							esc_attr( __( 'Update Drag & Drop Layout Now', 'elementor' ) )
						);
						?>
					</p>
				</div>
				<div class="co-message-action">
					<a class="button co-button" href="<?php echo $upgrade_url; ?>">
	...
	private function notice_api_notice() {
		...
		?>
		<div class="notice is-dismissible updated co-message-dismissed co-message-announcement" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
	...
	private function notice_tracker() {
		...
		$tracker_description_text = __( 'Love using Drag & Drop Layout? Become a super contributor by opting in to our non-sensitive plugin data collection and to our updates. We guarantee no sensitive data is collected.', 'elementor' );
		...
		?>
		<div class="notice updated co-message">
			<div class="co-message-inner">
				<div class="co-message-icon">
					<div class="e-logo-wrapper">
						<i class="eicon-elementor" aria-hidden="true"></i>
				...
				<div class="co-message-content">
					<p><?php echo esc_html( $tracker_description_text ); ?> <a href="#" target="_blank"><?php echo __( 'Learn more.', 'elementor' ); ?></a></p>
					<p class="co-message-actions">
		...
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				...
				<div class="co-message-content">
					...
					<p class="co-message-actions">
						<a href="#" target="_blank" class="button button-primary"><?php _e( 'Happy To Help', 'elementor' ); ?></a>
						<a href="<?php echo esc_url_raw( $dismiss_url ); ?>" class="button co-button-notice-dismiss"><?php _e( 'Hide Notification', 'elementor' ); ?></a>
					</p>
				</div>
			</div>
		</div>
	...
	private function notice_woocommerce_promote() {
		...
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				...
				<div class="co-message-content">
					<p><?php _e( 'Using WooCommerce? With Drag & Drop Layout Pro’s WooCommerce Builder, you’ll be able to design your store without coding!', 'elementor' ); ?></p>
					<p class="co-message-actions">
						<a href="#" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'elementor' ); ?></a>
					</p>
				</div>
			</div>
		</div>
	...
	private function notice_cf7_promote() {
		...
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				...
				<div class="co-message-content">
					<p><?php _e( 'Using Drag & Drop Layout & Contact Form 7? Try out Drag & Drop Layout Pro and design your forms visually with one powerful tool.', 'elementor' ); ?></p>
					<p class="co-message-actions">
						<a href="#" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'elementor' ); ?></a>
					</p>
				</div>
	...
	private function notice_mc4wp_promote() {
		...
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				...
				<div class="co-message-content">
					<p><?php _e( 'Want to design better MailChimp forms? Use Drag & Drop Layout Pro and enjoy unlimited integrations, visual design, templates and more.', 'elementor' ); ?></p>
					<p class="co-message-actions">
						<a href="#" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'elementor' ); ?></a>
					</p>
				</div>
	...
	private function notice_popup_maker_promote() {
		...
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				...
				<div class="co-message-content">
					<p><?php _e( 'Using popups on your site? Build outstanding popups using Drag & Drop Layout Pro and get more leads, sales and subscribers.', 'elementor' ); ?></p>
					<p class="co-message-actions">
						<a href="#" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'elementor' ); ?></a>
					</p>
				</div>
	...
	private function notice_role_manager_promote() {
		...
		<div class="notice updated is-dismissible co-message co-message-dismissed" data-notice_id="<?php echo esc_attr( $notice_id ); ?>">
			<div class="co-message-inner">
				...
				<div class="co-message-content">
					<p><?php _e( 'Managing a multi-user site? With Drag & Drop Layout Pro, you can control user access and make sure no one messes up your design.', 'elementor' ); ?></p>
					<p class="co-message-actions">
						<a href="#" target="_blank" class="button button-secondary"><?php _e( 'Learn More', 'elementor' ); ?></a>
					</p>
				</div>
