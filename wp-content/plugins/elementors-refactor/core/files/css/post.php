...
/**
 * Drag & Drop Layout post CSS file.
 *
 * Drag & Drop Layout CSS file handler class is responsible for generating the single
 * post CSS file.
 *
 * @since 1.2.0
 */
class Post extends Base {
	...
	/**
	 * Drag & Drop Layout post CSS file prefix.
	 */
	...
	public function get_element_unique_selector( Element_Base $element ) {
		return '.co-' . $this->post_id . ' .co-element' . $element->get_unique_selector();
	}
