...
class Role_Manager extends Settings_Page {
	...
	public function display_settings_page() {
		...
		<div class="wrap">
			...
			<div id="co-role-manager">
				<h3><?php echo __( 'Manage What Your Users Can Edit In Drag & Drop Layout', 'elementor' ); ?></h3>
				<form id="co-settings-form" method="post" action="options.php">
					<?php
					settings_fields( static::PAGE_ID );
					echo '<div class="co-settings-form-page co-active">';
	...
	private function display_role_controls( $role_slug, $role_data ) {
		...
		?>
		<div class="co-role-row <?php echo esc_attr( $role_slug ); ?>">
			<div class="co-role-label">
				<span class="co-role-name"><?php echo esc_html( $role_data['name'] ); ?></span>
				<span data-excluded-label="<?php esc_attr_e( 'Role Excluded', 'elementor' ); ?>" class="co-role-excluded-indicator"></span>
				<span class="co-role-toggle"><span class="dashicons dashicons-arrow-down"></span></span>
			</div>
			<div class="co-role-controls hidden">
				<div class="co-role-control">
					<label>
	...
	public function get_go_pro_link_html() {
		$pro_link = Utils::get_pro_link( '#' );
		?>
		<div class="co-role-go-pro">
			<div class="co-role-go-pro__desc"><?php echo __( 'Want to give access only to content?', 'elementor' ); ?></div>
			<div class="co-role-go-pro__link"><a class="co-button co-button-default co-button-go-pro" target="_blank" href="<?php echo esc_url( $pro_link ); ?>"><?php echo __( 'Go Pro', 'elementor' ); ?></a></div>
		</div>
		<?php
	}
