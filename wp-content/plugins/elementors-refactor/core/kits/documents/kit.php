...
class Kit extends PageBase {
	...
	public function get_css_wrapper_selector() {
		return 'body.co-kit-' . $this->get_main_id();
	}
		...
		if ( ! $this->custom_colors_disabled || ! $this->typography_schemes_disabled ) {
			$this->add_control(
				...
				[
					...
					'raw' => sprintf( __( 'In order for Theme Style to affect all relevant Drag & Drop Layout elements, please disable Default Colors and Fonts from the <a href="%s" target="_blank">Settings Page</a>.', 'elementor' ), Settings::get_url() ),
	...
	private function add_buttons_section() {
		...
		$button_hover_selectors = [
			...
			'{{WRAPPER}} .co-button:hover',
			'{{WRAPPER}} .co-button:focus',
		];
