...
class Manager {
	 ...
	 *
	 * Initializing Drag & Drop Layout dynamic tags manager.
	 *
	 * @since 2.0.0
	 * @access public
	 */
	...
	public function get_tags() {
		if ( ! did_action( 'elementor/dynamic_tags/register_tags' ) ) {
			 ...
			 *
			 * Fires when Drag & Drop Layout registers dynamic tags.
			 *
			 * @since 2.0.9
			 *
	...
	public function ajax_render_tags( $data ) {
		 ...
		 *
		 * Fires before Drag & Drop Layout renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
		 ...
		 *
		 * Fires after Drag & Drop Layout renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
