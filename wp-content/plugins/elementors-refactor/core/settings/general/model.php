...
/**
 * Drag & Drop Layout global settings model.
 *
 * Drag & Drop Layout global settings model handler class is responsible for registering
 * and managing Drag & Drop Layout global settings models.
 *
 * @since 1.6.0
 */
				...
				'style' => [
					...
					'controls' => [
						...
						'elementor_container_width' => [
							...
							'selectors' => [
								'.co-section.co-section-boxed > .co-container' => 'max-width: {{VALUE}}px',
							],
						],
						'elementor_space_between_widgets' => [
							...
							'selectors' => [
								'.co-widget:not(:last-child)' => 'margin-bottom: {{VALUE}}px',
							],
						],
						...
						'elementor_page_title_selector' => [
							...
							'description' => __( 'Drag & Drop Layout lets you hide the page title. This works for themes that have "h1.entry-title" selector. If your theme\'s selector is different, please enter it above.', 'elementor' ),
							'label_block' => true,
						],
					],
				],
				...
				'lightbox' => [
					...
					'controls' => [
						...
						'elementor_lightbox_color' => [
							...
							'selectors' => [
								'.co-lightbox' => 'background-color: {{VALUE}}',
							],
						],
						'elementor_lightbox_ui_color' => [
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'.co-lightbox' => '--lightbox-ui-color: {{VALUE}}',
							],
						],
						'elementor_lightbox_ui_color_hover' => [
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'.co-lightbox' => '--lightbox-ui-color-hover: {{VALUE}}',
							],
						],
						'elementor_lightbox_text_color' => [
							...
							'type' => Controls_Manager::COLOR,
							'selectors' => [
								'.co-lightbox' => '--lightbox-text-color: {{VALUE}}',
							],
						],
						'lightbox_icons_size' => [
							...
							'selectors' => [
								'.co-lightbox' => '--lightbox-header-icons-size: {{SIZE}}{{UNIT}}',
							],
							'separator' => 'before',
						],
						'lightbox_slider_icons_size' => [
							...
							'type' => Controls_Manager::SLIDER,
							'selectors' => [
								'.co-lightbox' => '--lightbox-navigation-icons-size: {{SIZE}}{{UNIT}}',
							],
							'separator' => 'before',
						],
					],
