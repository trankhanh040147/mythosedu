...
/**
 * Drag & Drop Layout settings base manager.
 *
 * Drag & Drop Layout settings base manager handler class is responsible for registering
 * and managing Drag & Drop Layout settings base managers.
 *
 * @since 1.6.0
 * @abstract
 */
abstract class Manager {
	 ...
	 *
	 * Initializing Drag & Drop Layout settings base manager.
	 *
	 * @since 1.6.0
	 * @access public
	 */
	...
	protected function print_editor_template_content( $name ) {
		...
		<# } #>
		<div id="co-panel-<?php echo $name; ?>-settings-controls"></div>
		<?php
	}
	...
	private function get_editor_template() {
		...
		ob_start();
		?>
		<script type="text/template" id="tmpl-co-panel-<?php echo esc_attr( $name ); ?>-settings">
