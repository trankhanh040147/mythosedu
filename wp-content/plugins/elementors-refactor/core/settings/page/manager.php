...
/**
 * Drag & Drop Layout page settings manager.
 *
 * Drag & Drop Layout page settings manager handler class is responsible for registering
 * and managing Drag & Drop Layout page settings managers.
 *
 * @since 1.6.0
 */
