...
/**
 * Drag & Drop Layout page settings model.
 *
 * Drag & Drop Layout page settings model handler class is responsible for registering
 * and managing Drag & Drop Layout page settings models.
 *
 * @since 1.6.0
 */
class Model extends CSS_Model {
	 ...
	 * Model constructor.
	 *
	 * Initializing Drag & Drop Layout page settings model.
	 *
	 * @since 1.6.0
	 * @access public
	 *
	 ...
	 * exclude it from the exported Drag & Drop Layout data.
	 *
	 * @since 1.6.0
	 * @access public
	 *
