...
/**
 * Drag & Drop Layout settings manager.
 *
 * Drag & Drop Layout settings manager handler class is responsible for registering and
 * managing Drag & Drop Layout settings managers.
 *
 * @since 1.6.0
 */
class Manager {
	 ...
	 *
	 * Holds the names for builtin Drag & Drop Layout settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 *
	 ...
	 *
	 * Register builtin Drag & Drop Layout settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
