...
(function ($) {
  var ElementorAdmin = elementorModules.ViewModule.extend({
    ...
    getDefaultElements: function getDefaultElements() {
      var elements = {
        $switchMode: $('#co-switch-mode'),
        $goToEditLink: $('#co-go-to-edit-page-link'),
        $switchModeInput: $('#co-switch-mode-input'),
        $switchModeButton: $('#co-switch-mode-button'),
        $elementorLoader: $('.co-loader'),
        $builderEditor: $('#co-editor'),
        $importButton: $('#co-import-template-trigger'),
        $importArea: $('#co-import-template-area'),
        $settingsForm: $('#co-settings-form'),
        $settingsTabsWrapper: $('#co-settings-tabs-wrapper')
      };
      elements.$settingsFormPages = elements.$settingsForm.find('.co-settings-form-page');
      elements.$activeSettingsPage = elements.$settingsFormPages.filter('.co-active');
    ...
    toggleStatus: function toggleStatus() {
      ...
      elementorCommon.elements.$body.toggleClass('co-editor-active', isElementorMode).toggleClass('co-editor-inactive', !isElementorMode);
    },
    bindEvents: function bindEvents() {
      ...
      $('div.notice.co-message-dismissed').on('click', 'button.notice-dismiss, .co-button-notice-dismiss', function (event) {
        event.preventDefault();
        $.post(ajaxurl, {
          action: 'elementor_set_admin_notice_viewed',
          notice_id: $(this).closest('.co-message-dismissed').data('notice_id')
        });
        var $wrapperElm = $(this).closest('.co-message-dismissed');
      ...
      $('#co-clear-cache-button').on('click', function (event) {
        event.preventDefault();
        var $thisButton = $(this);
      ...
      $('#co-library-sync-button').on('click', function (event) {
        event.preventDefault();
        var $thisButton = $(this);
        $thisButton.removeClass('success').addClass('loading');
        $.post(ajaxurl, {
      ...
      $('#co-replace-url-button').on('click', function (event) {
        event.preventDefault();
        var $this = $(this),
            $tr = $this.parents('tr'),
      ...
      $('select.co-rollback-select').on('change', function () {
        var $this = $(this),
            $rollbackButton = $this.next('.co-rollback-button'),
      ...
      $('.co-rollback-button').on('click', function (event) {
        event.preventDefault();
        var $this = $(this);
        elementorCommon.dialogsManager.createWidget('confirm', {
      ...
      $('.elementor_css_print_method select').on('change', function () {
        var $descriptions = $('.co-css-print-method-description');
        $descriptions.hide();
    ...
    initTemplatesImport: function initTemplatesImport() {
      ...
      $importButton.on('click', function () {
        $('#co-import-template-area').toggle();
      });
    },
    ...
    animateLoader: function animateLoader() {
      this.elements.$goToEditLink.addClass('co-animate');
    },
    ...
    goToSettingsTab: function goToSettingsTab(tabName) {
      ...
      this.elements.$activeSettingsPage.removeClass('co-active');
      this.elements.$activeSettingsTab.removeClass('nav-tab-active');
      var $activeTab = this.elements.$settingsTabs.filter('#co-settings-' + tabName);
      $activePage.addClass('co-active');
    ...
    roleManager: {
      selectors: {
        body: 'co-role-manager',
        row: '.co-role-row',
        label: '.co-role-label',
        excludedIndicator: '.co-role-excluded-indicator',
        excludedField: 'input[name="elementor_exclude_user_roles[]"]',
        controlsContainer: '.co-role-controls',
        toggleHandle: '.co-role-toggle',
  ...
  getDefaultSettings: function getDefaultSettings() {
    return {
      selectors: {
        ...
        maintenanceModeDescriptions: '.co-maintenance-mode-description',
        ...
        editTemplateButton: '.co-edit-template',
        maintenanceModeError: '.co-maintenance-mode-error'
      },
      classes: {
        isEnabled: 'co-maintenance-mode-is-enabled'
      }
    };
  },
  getDefaultElements: function getDefaultElements() {
