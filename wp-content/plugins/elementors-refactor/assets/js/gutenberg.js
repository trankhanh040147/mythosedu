...
(function ($) {
  ...
  var ElementorGutenbergApp = {
    cacheElements: function cacheElements() {
      ...
      this.cache.$switchMode = $($('#co-gutenberg-button-switch-mode').html());
      this.cache.$gutenberg.find('.edit-post-header-toolbar').append(this.cache.$switchMode);
      this.cache.$switchModeButton = this.cache.$switchMode.find('#co-switch-mode-button');
      this.toggleStatus();
      this.buildPanel();
      var self = this;
    ...
    buildPanel: function buildPanel() {
      ...
      if (!$('#co-editor').length) {
        self.cache.$editorPanel = $($('#co-gutenberg-panel').html()); // TODO: `editor-block-list__layout` class for WP < 5.3 support.
        ...
        self.cache.$editorPanelButton = self.cache.$editorPanel.find('#co-go-to-edit-page-link');
    ...
    animateLoader: function animateLoader() {
      this.cache.$editorPanelButton.addClass('co-animate');
    },
    toggleStatus: function toggleStatus() {
      jQuery('body').toggleClass('co-editor-active', this.isElementorMode).toggleClass('co-editor-inactive', !this.isElementorMode);
    },
    init: function init() {
      var self = this;
      setTimeout(function () {
