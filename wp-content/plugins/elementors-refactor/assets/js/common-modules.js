...
function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'co-templates-modal__header';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-templates-modal__header';
    }
  }, {
    key: "regions",
    value: function regions() {
      return {
        logoArea: '.co-templates-modal__header__logo-area',
        tools: '#co-template-library-header-tools',
        menuArea: '.co-templates-modal__header__menu-area'
      };
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        closeModal: '.co-templates-modal__header__close'
      };
    }
  }, {
    key: "events",
...
function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-templates-modal__header__logo';
    }
  }, {
    key: "className",
    value: function className() {
      return 'co-templates-modal__header__logo';
    }
  }, {
    key: "events",
    value: function events() {
...
function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'co-template-library-loading';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-template-library-loading';
    }
  }]);
  return _default;
}(Marionette.ItemView);
