  ...
  (0, _createClass2.default)(Preview, [{
    ...
    value: function createDocumentsHandles() {
      ...
      jQuery.each(elementorFrontend.documentsManager.documents, function (index, document) {
        ...
        if ($documentElement.hasClass('co-edit-mode')) {
          return;
        }

        var $existingHandle = document.$element.children('.co-document-handle');
        ...
        var $handle = jQuery('<div>', {
          class: 'co-document-handle'
        }),
            $handleIcon = jQuery('<i>', {
          class: 'eicon-edit'
        }),
            documentTitle = $documentElement.data('co-title'),
            $handleTitle = jQuery('<div>', {
          class: 'co-document-handle__title'
