...
ControlsStack = Marionette.CompositeView.extend({
  classes: {
    popover: 'co-controls-popover'
  },
  activeTab: null,
  activeSection: null,
  className: function className() {
    return 'co-controls-stack';
  },
  ...
  ui: function ui() {
    return {
      tabs: '.co-panel-navigation-tab',
      reloadButton: '.co-update-preview-button'
    };
  },
  ...
  openActiveSection: function openActiveSection() {
    ...
    if (activeSectionView[0]) {
      activeSectionView[0].$el.addClass('co-open');
  ...
  onDeviceModeChange: function onDeviceModeChange() {
    if ('desktop' === elementor.channels.deviceMode.request('currentMode')) {
      this.$el.removeClass('co-responsive-switchers-open');
    }
  },
  onChildviewControlSectionClicked: function onChildviewControlSectionClicked(childView) {
    var isSectionOpen = childView.$el.hasClass('co-open');
  ...
  onChildviewResponsiveSwitcherClick: function onChildviewResponsiveSwitcherClick(childView, device) {
    if ('desktop' === device) {
      this.$el.toggleClass('co-responsive-switchers-open');
    }
  }
});
