  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          elements: '.co-element',
          nestedDocumentElements: '.elementor .co-element'
        },
        classes: {
          editMode: 'co-edit-mode'
        }
      };
    }
  }, {
    ...
    value: function getDocumentSettings(setting) {
      ...
      if (this.isEdit) {
        ...
        elementSettings = this.$element.data('co-settings') || {};
      }
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(BackgroundSlideshow, [{
    ...
    value: function getDefaultSettings() {
      return {
        classes: {
          swiperContainer: 'co-background-slideshow swiper-container',
          swiperWrapper: 'swiper-wrapper',
          swiperSlide: 'co-background-slideshow__slide swiper-slide',
          swiperSlideInner: 'co-background-slideshow__slide__image',
          kenBurns: 'co-ken-burns',
          kenBurnsActive: 'co-ken-burns--active',
          kenBurnsIn: 'co-ken-burns--in',
          kenBurnsOut: 'co-ken-burns--out'
        }
      };
    }
  }, {
...
function (_elementorModules$Vie) {
  ...
  (0, _createClass2.default)(Frontend, [{
    ...
    value: function addIeCompatibility() {
      ...
      var msieCss = '<link rel="stylesheet" id="co-frontend-css-msie" href="' + this.config.urls.assets + 'css/frontend-msie.min.css?' + this.config.version + '" type="text/css" />';
      this.elements.$body.append(msieCss);
    }
  }, {
    key: "setDeviceModeData",
    value: function setDeviceModeData() {
      this.elements.$body.attr('data-co-device-mode', this.getCurrentDeviceMode());
    }
  }, {
    key: "addListenerOnce",
...
function (_elementorModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function createActionHash(action, settings) {
      return encodeURIComponent("#co-action:action=".concat(action, "&settings=").concat(btoa((0, _stringify.default)(settings))));
    }
  }, {
    key: "onInit",
    value: function onInit() {
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(Alert, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          dismissButton: '.co-alert-dismiss'
        }
      };
    }
  }, {
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(Counter, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          counterNumber: '.co-counter-number'
        }
      };
    }
  }, {
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(Progress, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          progressNumber: '.co-progress-bar'
        }
      };
    }
  }, {
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(VideoModule, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          imageOverlay: '.co-custom-embed-image-overlay',
          video: '.co-video',
          videoIframe: '.co-video-iframe'
        }
      };
    }
  }, {
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(ImageCarouselHandler, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          carousel: '.co-image-carousel-wrapper',
    ...
    value: function getSwiperSettings() {
      ...
      if (showArrows) {
        swiperOptions.navigation = {
          prevEl: '.co-swiper-button-prev',
          nextEl: '.co-swiper-button-next'
        };
      }
  ...
  (0, _createClass2.default)(TextEditor, [{
    ...
    value: function getDefaultSettings() {
      return {
        ...
        classes: {
          dropCap: 'co-drop-cap',
          dropCapLetter: 'co-drop-cap-letter'
        }
      };
    }
  }, {
...
var _default = function _default($scope) {
  if (elementorFrontend.isEditMode() || $scope.hasClass('co-section-stretched')) {
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(BackgroundVideo, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          backgroundVideoContainer: '.co-background-video-container',
          backgroundVideoEmbed: '.co-background-video-embed',
          backgroundVideoHosted: '.co-background-video-hosted'
        }
      };
    }
  }, {
    ...
    value: function prepareVimeoVideo(Vimeo, videoId) {
      ...
      this.player.ready().then(function () {
        jQuery(_this2.player.element).addClass('co-background-video-embed');
    ...
    value: function prepareYTVideo(YT, videoID) {
      ...
      $backgroundVideoContainer.addClass('co-loading co-invisible');
      this.player = new YT.Player(this.elements.$backgroundVideoEmbed[0], {
        ...
        events: {
          ...
          onStateChange: function onStateChange(event) {
            switch (event.data) {
              case startStateCode:
                $backgroundVideoContainer.removeClass('co-invisible co-loading');
                break;
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(HandlesPosition, [{
    ...
    value: function isFirstSection() {
      return this.$element.is('.co-edit-mode .co-top-section:first');
    }
  }, {
    ...
    value: function setHandlesPosition() {
      ...
      var offset = isOverflowHidden ? 0 : this.getOffset(),
          $handlesElement = this.$element.find('> .co-element-overlay > .co-editor-section-settings'),
          insideHandleClass = 'co-section--handles-inside';
...
function (_elementorModules$fro) {
  ...
  (0, _createClass2.default)(GlobalHandler, [{
    ...
    value: function animate() {
      ...
      if ('none' === animation) {
        $element.removeClass('co-invisible');
        return;
      }
      ...
      setTimeout(function () {
        $element.removeClass('co-invisible').addClass('animated ' + animation);
      }, animationDelay);
    }
  }, {
    key: "getAnimation",
...
module.exports = elementorModules.ViewModule.extend({
  getDefaultSettings: function getDefaultSettings() {
    return {
      ...
      selectors: {
        links: 'a[href*="#"]',
        targets: '.co-element, .co-menu-anchor',
  ...
  handleAnchorLinks: function handleAnchorLinks(event) {
    ...
    var scrollTop = $anchor.offset().top,
        ...
        $activeStickies = jQuery('.co-section.co-sticky--active:visible'),
        maxStickyHeight = 0;
...
module.exports = elementorModules.ViewModule.extend({
  ...
  getDefaultSettings: function getDefaultSettings() {
    return {
      classes: {
        aspectRatio: 'co-aspect-ratio-%s',
        item: 'co-lightbox-item',
        image: 'co-lightbox-image',
        videoContainer: 'co-video-container',
        videoWrapper: 'co-fit-aspect-ratio',
        playButton: 'co-custom-embed-play',
        playButtonIcon: 'fa',
        playing: 'co-playing',
        hidden: 'co-hidden',
        invisible: 'co-invisible',
        preventClose: 'co-lightbox-prevent-close',
        slideshow: {
          container: 'swiper-container',
          slidesWrapper: 'swiper-wrapper',
          prevButton: 'co-swiper-button co-swiper-button-prev',
          nextButton: 'co-swiper-button co-swiper-button-next',
          prevButtonIcon: 'eicon-chevron-left',
          nextButtonIcon: 'eicon-chevron-right',
          slide: 'swiper-slide',
          header: 'co-slideshow__header',
          footer: 'co-slideshow__footer',
          title: 'co-slideshow__title',
          description: 'co-slideshow__description',
          counter: 'co-slideshow__counter',
          iconExpand: 'eicon-frame-expand',
          iconShrink: 'eicon-frame-minimize',
          iconZoomIn: 'eicon-zoom-in-bold',
          iconZoomOut: 'eicon-zoom-out-bold',
          iconShare: 'eicon-share-arrow',
          shareMenu: 'co-slideshow__share-menu',
          shareLinks: 'co-slideshow__share-links',
          hideUiVisibility: 'co-slideshow--ui-hidden',
          shareMode: 'co-slideshow--share-mode',
          fullscreenMode: 'co-slideshow--fullscreen-mode',
          zoomMode: 'co-slideshow--zoom-mode'
        }
      },
      selectors: {
        links: 'a, [data-co-lightbox]',
        slideshow: {
  ...
  setVideoContent: function setVideoContent(options) {
    ...
    modal.onHide = function () {
      onHideMethod();
      modal.getElements('message').removeClass('co-fit-aspect-ratio');
    };
  },
  getShareLinks: function getShareLinks() {
    ...
    var i18n = elementorFrontend.config.i18n,
      ...
      class: classes.slideshow.shareLinks
        ...
        $image = $activeSlide.find('.co-lightbox-image'),
        videoUrl = $activeSlide.data('co-slideshow-video');
    var itemUrl;
  ...
  setSlideshowContent: function setSlideshowContent(options) {
    ...
    options.slides.forEach(function (slide) {
      ...
      if (slide.video) {
        $slide.attr('data-co-slideshow-video', slide.video);
        var $playIcon = $('<div>', {
  ...
  prepareYTVideo: function prepareYTVideo(YT, videoID, $videoContainer, $videoWrapper, $playIcon) {
    ...
    $videoContainer.addClass('co-loading' + ' ' + classes.invisible);
      ...
      events: {
        ...
        onStateChange: function onStateChange(event) {
          if (event.data === startStateCode) {
            $videoContainer.removeClass('co-loading' + ' ' + classes.invisible);
          }
        }
      },
      playerVars: {
  ...
  openSlideshow: function openSlideshow(slideshowID, initialSlideURL) {
    ...
    this.showModal({
      ...
      id: slideshowID,
      modalOptions: {
        id: 'co-lightbox-slideshow-' + slideshowID
      },
      slideshow: {
        slides: slides,
        swiper: {
  ...
  openLink: function openLink(event) {
    var element = event.currentTarget,
        ...
        isClickInsideElementor = !!$target.closest('.co-edit-area').length;
