  ...
  var ElementorAdminDialogApp = {
    cacheElements: function cacheElements() {
      this.cache = {
        ...
        $dialogHeader: $('#co-deactivate-feedback-dialog-header'),
        $dialogForm: $('#co-deactivate-feedback-dialog-form')
      };
    },
      ...
      self.getModal = function () {
        if (!modal) {
          modal = elementorCommon.dialogsManager.createWidget('lightbox', {
            id: 'co-deactivate-feedback-modal',
            ...
            onShow: function onShow() {
              var $dialogModal = $('#co-deactivate-feedback-modal'),
                  radioSelector = '.co-deactivate-feedback-dialog-input';
    ...
    sendFeedback: function sendFeedback() {
      ...
      self.getModal().getElements('submit').text('').addClass('co-loading');
