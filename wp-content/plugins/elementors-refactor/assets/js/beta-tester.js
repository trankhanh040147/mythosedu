  ...
  (0, _createClass2.default)(BetaTesterLayout, [{
    ...
    value: function ui() {
      return {
        ...
        dontShowAgain: '.co-beta-tester-do-not-show-again'
      };
    }
  }, {
    key: "events",
    ...
    value: function initialize() {
      ...
      this.modalHeader.currentView.ui.closeModal.after(jQuery('<div>', {
        class: 'co-beta-tester-do-not-show-again'
      }).text(doNotShowAgain));
    }
  }, {
    key: "showContentView",
...
function (_Marionette$ItemView) {
  ...
  function BetaTesterView() {
    ...
    _this.id = 'co-beta-tester-dialog-content';
    _this.template = '#tmpl-co-beta-tester';
    return _this;
  }
  ...
  (0, _createClass2.default)(BetaTesterView, [{
    ...
    value: function ui() {
      return {
        betaForm: '#co-beta-tester-form',
        betaEmail: '#co-beta-tester-form__email',
        betaButton: '#co-beta-tester-form__submit'
      };
    }
  }, {
    key: "events",
    ...
    value: function onBetaFormSubmit(event) {
      ...
      this.ui.betaButton.addClass('co-button-state');
