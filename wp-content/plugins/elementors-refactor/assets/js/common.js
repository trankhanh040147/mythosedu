  ...
  (0, _createClass2.default)(HooksBase, [{
    ...
    value: function checkInstance(instance) {
      if (instance.getType() !== this.getType()) {
        throw new Error("invalid instance, please use: 'co-api/modules/hook-base.js'. ");
      }
    }
    /**
     * Function checkId().
...
function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function className() {
      return 'co-finder__results__category';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-finder__results__category';
    }
  }, {
    key: "getChildView",
    ...
    key: "initialize",
    value: function initialize() {
      this.childViewContainer = '.co-finder__results__category__items';
      this.isVisible = true;
...
function (_Marionette$LayoutVie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-finder';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        searchInput: '#co-finder__search__input'
      };
    }
  }, {
    key: "events",
...
function (_Marionette$Composite) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "id",
    value: function id() {
      return 'co-finder__results-container';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        noResults: '#co-finder__no-results',
        categoryItem: '.co-finder__results__item'
      };
    }
  }, {
    key: "events",
    ...
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-finder-results-container';
    }
  }, {
    key: "getChildView",
    ...
    value: function initialize() {
      ...
      this.childViewContainer = '#co-finder__results';
    ...
    value: function activateItem($item) {
      if (this.$activeItem) {
        this.$activeItem.removeClass('co-active');
      }

      $item.addClass('co-active');
...
function (_Marionette$ItemView) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return 'co-finder__results__item';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate() {
      return '#tmpl-co-finder__results__item';
    }
  }]);
  return _default;
}(Marionette.ItemView);
...
function (_Category) {
  ...
  (0, _createClass2.default)(_default, [{
    key: "className",
    value: function className() {
      return (0, _get2.default)((0, _getPrototypeOf2.default)(_default.prototype), "className", this).call(this) + ' co-finder__results__category--dynamic';
    }
  }, {
    key: "ui",
    value: function ui() {
      return {
        title: '.co-finder__results__category__title'
      };
    }
  }, {
    key: "fetchData",
...
function (_elementorModules$Vie) {
  ...
  (0, _createClass2.default)(_default, [{
    ...
    value: function getDefaultSettings() {
      return {
        selectors: {
          connectButton: '#co-template-library-connect__button'
        }
      };
    }
  }, {
    ...
    value: function handle(event) {
      ...
      var filteredHandlers = handlers.filter(function (handler) {
        if (handler.exclude && -1 !== handler.exclude.indexOf('input')) {
          ...
          if ($target.is(':input, .co-input') || $target.closest('[contenteditable="true"]').length) {
            return false;
          }
        }
