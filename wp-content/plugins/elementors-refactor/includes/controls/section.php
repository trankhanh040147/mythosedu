...
/**
 * Drag & Drop Layout section control.
 *
...
class Control_Section extends Base_UI_Control {
	...
	public function content_template() {
		...
		<div class="co-panel-heading">
			<div class="co-panel-heading-toggle co-section-toggle" data-collapse_id="{{ data.name }}">
				<i class="eicon" aria-hidden="true"></i>
			</div>
			<div class="co-panel-heading-title co-section-title">{{{ data.label }}}</div>
		</div>
		<?php
	}
