...
abstract class Base_Control extends Base_Object {
	 ...
	 * Get features.
	 *
	 * Retrieve the list of all the available features. Currently Drag & Drop Layout uses only
	 * the `UI` feature.
	 *
	 * @since 1.5.0
	 * @access public
	...
	final public function print_template() {
		?>
		<script type="text/html" id="tmpl-co-control-<?php echo esc_attr( $this->get_type() ); ?>-content">
			<div class="co-control-content">
				<?php
