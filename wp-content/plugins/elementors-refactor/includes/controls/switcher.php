...
/**
 * Drag & Drop Layout switcher control.
 *
	...
	public function content_template() {
		...
		<div class="co-control-field">
			...
			<div class="co-control-input-wrapper">
				<label class="co-switch co-control-unit-2">
					<input id="<?php echo $control_uid; ?>" type="checkbox" data-setting="{{ data.name }}" class="co-switch-input" value="{{ data.return_value }}">
					<span class="co-switch-label" data-on="{{ data.label_on }}" data-off="{{ data.label_off }}"></span>
