...
/**
 * Drag & Drop Layout date/time control.
 *
	...
	public function content_template() {
		...
		<div class="co-control-field">
			...
			<div class="co-control-input-wrapper">
				<input id="<?php echo $control_uid; ?>" placeholder="{{ data.placeholder }}" class="co-date-time-picker flatpickr" type="text" data-setting="{{ data.name }}">
			</div>
		</div>
		<# if ( data.description ) { #>
