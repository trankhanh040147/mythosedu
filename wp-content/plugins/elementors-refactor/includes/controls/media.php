...
/**
 * Drag & Drop Layout media control.
 *
			...
			<div class="co-control-input-wrapper co-aspect-ratio-219">
				<div class="co-control-media__content co-control-tag-area co-control-preview-area co-fit-aspect-ratio">
					...
					<div class="co-control-media-area co-fit-aspect-ratio">
						...
						<video class="co-control-media-video" preload="metadata"></video>
						<i class="eicon-video-camera"></i>
						<# } #>
					</div>
					<div class="co-control-media__tools co-control-dynamic-switcher-wrapper">
						<# if( 'image' === data.media_type ) { #>
						<div class="co-control-media__tool co-control-media__replace"><?php echo __( 'Choose Image', 'elementor' ); ?></div>
						<# } else if( 'video' === data.media_type ) { #>
						<div class="co-control-media__tool co-control-media__replace"><?php echo __( 'Choose Video', 'elementor' ); ?></div>
						<# } #>
					</div>
				</div>
			</div>
