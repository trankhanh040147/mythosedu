	...
	public function content_template() {
		...
		<div class="co-control-field">
			...
			<div class="co-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="co-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo __( 'Select Icon', 'elementor' ); ?>">
