...
class Control_Font extends Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="co-control-field">
			...
			<div class="co-control-input-wrapper co-control-unit-5">
				<select id="<?php echo $control_uid; ?>" class="co-control-font-family" data-setting="{{ data.name }}">
