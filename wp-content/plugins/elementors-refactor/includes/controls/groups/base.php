...
/**
 * Drag & Drop Layout group control base.
 *
...
abstract class Group_Control_Base implements Group_Control_Interface {
	...
	public function get_base_group_classes() {
		return 'co-group-control-' . static::get_type() . ' co-group-control';
	}
	...
	protected function add_group_args_to_field( $control_id, $field_args ) {
		...
		$field_args['classes'] = $this->get_base_group_classes() . ' co-group-control-' . $control_id;
	 ...
	 *
	 * This way Drag & Drop Layout can apply condition logic to a specific control in a
	 * group control.
	 *
	 * @since 1.2.0
	 * @access private
	 ...
	 * group control, Drag & Drop Layout needs to apply the selector to different fields.
