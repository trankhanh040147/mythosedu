...
/**
 * Drag & Drop Layout background control.
 *
...
class Group_Control_Background extends Group_Control_Base {
	...
	public function init_fields() {
		...
		$fields['attachment_alert'] = [
			...
			'content_classes' => 'co-control-field-description',
		...
		$fields['video_link'] = [
			...
			'placeholder' => 'https://www.youtube.com/watch?v=fFdoohwUy0s',
		...
		$fields['slideshow_background_size'] = [
			...
			'selectors' => [
				'{{WRAPPER}} .co-background-slideshow__slide__image' => 'background-size: {{VALUE}};',
			],
			'condition' => [
				'background' => [ 'slideshow' ],
			],
		...
		$fields['slideshow_background_position'] = [
			...
			'selectors' => [
				'{{WRAPPER}} .co-background-slideshow__slide__image' => 'background-position: {{VALUE}};',
			],
			'condition' => [
				'background' => [ 'slideshow' ],
			],
	...
	protected function get_child_default_args() {
		return [
			...
			'selector' => '{{WRAPPER}}:not(.co-motion-effects-element-type-background), {{WRAPPER}} > .co-motion-effects-container > .co-motion-effects-layer',
		];
	}
