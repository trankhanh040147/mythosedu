...
/**
 * Drag & Drop Layout textarea control.
 *
	...
	public function content_template() {
		...
		<div class="co-control-field">
			...
			<div class="co-control-input-wrapper co-control-dynamic-switcher-wrapper">
				<textarea id="<?php echo $control_uid; ?>" class="co-control-tag-area" rows="{{ data.rows }}" data-setting="{{ data.name }}" placeholder="{{ data.placeholder }}"></textarea>
			</div>
		</div>
		<# if ( data.description ) { #>
