...
/**
 * Drag & Drop Layout repeater control.
 *
...
class Control_Repeater extends Base_Data_Control {
	...
	public function content_template() {
		?>
		<label>
			<span class="co-control-title">{{{ data.label }}}</span>
		</label>
		<div class="co-repeater-fields-wrapper"></div>
		<# if ( itemActions.add ) { #>
			<div class="co-button-wrapper">
				<button class="co-button co-button-default co-repeater-add" type="button">
