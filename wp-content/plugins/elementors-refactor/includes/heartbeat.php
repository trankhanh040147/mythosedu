...
/**
 * Drag & Drop Layout heartbeat.
 *
 * Drag & Drop Layout heartbeat handler class is responsible for initializing Elementor
...
class Heartbeat {
	 ...
	 * user doesn't need to log-in again as Drag & Drop Layout fetches the new nonce from
	 ...
	 *
	 * Initializing Drag & Drop Layout heartbeat.
	 *
	 * @since 1.0.0
	 * @access public
	 */
