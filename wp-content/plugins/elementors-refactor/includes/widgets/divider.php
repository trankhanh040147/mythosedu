...
/**
 * Drag & Drop Layout divider widget.
 *
 * Drag & Drop Layout widget that displays a line that divides different elements in the
 * page.
 *
 * @since 1.0.0
 */
class Widget_Divider extends Widget_Base {
	...
	private static function get_additional_styles() {
		 ...
		 * Additional Styles.
		 *
		 * Filters the styles used by Drag & Drop Layout to add additional divider styles.
		 *
		 * @since 2.7.0
		 *
		 * @param array $additional_styles Additional Drag & Drop Layout divider styles.
		 */
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'pattern',
				'prefix_class' => 'co-widget-divider--separator-type-',
				'condition' => [
					'style!' => [
						'',
						'solid',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HIDDEN,
				'default' => 'no-spacing',
				'prefix_class' => 'co-widget-divider--',
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-divider-separator' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-divider' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .co-divider-separator' => 'margin: 0 auto; margin-{{VALUE}}: 0',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'prefix_class' => 'co-widget-divider--view-',
				'render_type' => 'template',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-divider' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-divider__text' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .co-divider__text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'center',
				'prefix_class' => 'co-widget-divider--element-align-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .co-icon' => 'border-width: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'icon_view' => 'framed',
				],
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .co-icon' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'icon_view!' => 'default',
				],
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'co-divider' );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<span class="co-divider-separator">
			<?php if ( $has_icon ) : ?>
				<div class="co-icon co-divider__element">
					<?php
			...
			<?php elseif ( $has_text ) :
				...
				$this->add_render_attribute( 'text', [ 'class' => [ 'co-divider__text', 'co-divider__element' ] ] );
				?>
