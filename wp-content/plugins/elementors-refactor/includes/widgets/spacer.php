...
/**
 * Drag & Drop Layout spacer widget.
 *
 * Drag & Drop Layout widget that inserts a space that divides various elements.
 *
 * @since 1.0.0
 */
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-spacer-inner' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
