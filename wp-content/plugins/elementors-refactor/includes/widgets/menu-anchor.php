...
/**
 * Drag & Drop Layout menu anchor widget.
 *
 * Drag & Drop Layout widget that allows to link and menu to a specific position on the
 * page.
 *
 * @since 1.0.0
 */
class Widget_Menu_Anchor extends Widget_Base {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'inner', 'class', 'co-menu-anchor' );
		?>
	...
	protected function content_template() {
		?>
		<div class="co-menu-anchor"{{{ settings.anchor ? ' id="' + settings.anchor + '"' : '' }}}></div>
		<?php
	}
}
