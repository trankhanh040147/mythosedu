...
/**
 * Drag & Drop Layout image carousel widget.
 *
 * Drag & Drop Layout widget that displays a set of images in a rotating carousel or
 * slider.
 *
 * @since 1.0.0
 */
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'co-arrows-position-',
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-swiper-button.co-swiper-button-prev, {{WRAPPER}} .co-swiper-button.co-swiper-button-next' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .co-swiper-button.co-swiper-button-prev, {{WRAPPER}} .co-swiper-button.co-swiper-button-next' => 'color: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'co-pagination-position-',
				'condition' => [
					'navigation' => [ 'dots', 'both' ],
				],
			]
		...
		$this->add_group_control(
			...
			[
				'name' => 'image_border',
				'selector' => '{{WRAPPER}} .co-image-carousel-wrapper .co-image-carousel .swiper-slide-image',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .co-image-carousel-wrapper .co-image-carousel .swiper-slide-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .co-image-carousel-caption' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .co-image-carousel-caption' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .co-image-carousel-caption',
			]
		);
	...
	protected function render() {
		...
		foreach ( $settings['carousel'] as $index => $attachment ) {
			...
			if ( ! empty( $image_caption ) ) {
				$slide_html .= '<figcaption class="co-image-carousel-caption">' . $image_caption . '</figcaption>';
			}
		...
		$this->add_render_attribute( [
			'carousel' => [
				'class' => 'co-image-carousel swiper-wrapper',
			],
			'carousel-wrapper' => [
				'class' => 'co-image-carousel-wrapper swiper-container',
		...
		<div <?php echo $this->get_render_attribute_string( 'carousel-wrapper' ); ?>>
			...
			<?php if ( 1 < $slides_count ) : ?>
				...
				<?php endif; ?>
				<?php if ( $show_arrows ) : ?>
					<div class="co-swiper-button co-swiper-button-prev">
						<i class="eicon-chevron-left" aria-hidden="true"></i>
						<span class="co-screen-only"><?php _e( 'Previous', 'elementor' ); ?></span>
					</div>
					<div class="co-swiper-button co-swiper-button-next">
						<i class="eicon-chevron-right" aria-hidden="true"></i>
						<span class="co-screen-only"><?php _e( 'Next', 'elementor' ); ?></span>
					</div>
				<?php endif; ?>
			<?php endif; ?>
		</div>
