...
/**
 * Drag & Drop Layout WordPress widget.
 *
 * Drag & Drop Layout widget that displays all the WordPress widgets.
 *
 * @since 1.0.0
 */
class Widget_WordPress extends Widget_Base {
	...
	protected function render() {
		 ...
		 *
		 * Filters the WordPress widget arguments when they are rendered in Drag & Drop Layout panel.
		 *
		 * @since 1.0.0
		 *
