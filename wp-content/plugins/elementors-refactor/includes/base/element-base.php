...
/**
 * Drag & Drop Layout element base.
 *
 * An abstract class to register new Drag & Drop Layout elements. It extended the
...
abstract class Element_Base extends Controls_Stack {
	...
	public function print_element() {
		 ...
		 *
		 * Fires before Drag & Drop Layout element is rendered in the frontend.
		 *
		 * @since 2.2.0
		 *
		 ...
		 *
		 * Fires after Drag & Drop Layout element is rendered in the frontend.
		 *
		 * The dynamic portion of the hook name, `$element_type`, refers to the element type.
		 *
		 * @since 1.0.0
	 ...
	 * class for each HTML element. This way Drag & Drop Layout can set custom styles for
	 * each element.
	 *
	 * @since 1.0.0
	 * @access public
	...
	protected function _add_render_attributes() {
		...
		if ( ! empty( $settings['animation'] ) || ! empty( $settings['_animation'] ) ) {
			...
			$this->add_render_attribute( '_wrapper', 'class', 'co-invisible' );
		}
	 ...
	 * way Drag & Drop Layout renders data when initializing elements.
	 *
	 * @since 1.0.0
	 * @access public
	 *
