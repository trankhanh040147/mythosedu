...
/**
 * Drag & Drop Layout controls stack.
 *
...
abstract class Controls_Stack extends Base_Object {
	 ...
	 * The configuration.
	 *
	 * Holds the configuration used to generate the Drag & Drop Layout editor. It includes
	...
	public function start_controls_section( $section_id, array $args = [] ) {
		 ...
		 *
		 * Fires before Drag & Drop Layout section starts in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 ...
		 * After section start.
		 *
		 * Fires after Drag & Drop Layout section starts in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
	...
	public function end_controls_section() {
		 ...
		 * Before section end.
		 *
		 * Fires before Drag & Drop Layout section ends in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * After section end.
		 *
		 * Fires after Drag & Drop Layout section ends in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
	...
	public function print_template() {
		...
		?>
		<script type="text/html" id="tmpl-co-<?php echo esc_attr( $this->get_name() ); ?>-content">
