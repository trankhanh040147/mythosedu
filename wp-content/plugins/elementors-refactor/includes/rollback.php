...
/**
 * Drag & Drop Layout rollback.
 *
 * Drag & Drop Layout rollback handler class is responsible for rolling back Drag & Drop Layout to
 * previous version.
 *
 * @since 1.5.0
 */
class Rollback {
	 ...
	 *
	 * Initializing Drag & Drop Layout rollback.
	 *
	 * @since 1.5.0
	 * @access public
	 *
	 ...
	 * Upgrade.
	 *
	 * Run WordPress upgrade to rollback Drag & Drop Layout to previous version.
	 *
	 * @since 1.5.0
	 * @access protected
	 */
	 ...
	 * Run.
	 *
	 * Rollback Drag & Drop Layout to previous versions.
	 *
	 * @since 1.5.0
	 * @access public
	 */
