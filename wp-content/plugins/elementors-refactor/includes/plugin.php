...
class Plugin {
	...
	public static function instance() {
		if ( is_null( self::$instance ) ) {
			...
			/**
			 * Drag & Drop Layout loaded.
			 *
			 * Fires when Drag & Drop Layout was fully loaded and instantiated.
			 *
			 * @since 1.0.0
			 */
    ...
    function includes(){
        require ELEMENTOR_PATH . 'includes/modules-component.php';
    }
	 ...
	 * Init.
	 *
	 * Initialize Drag & Drop Layout Plugin. Register Drag & Drop Layout support for all the
	 * supported post types and initialize Drag & Drop Layout components.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function init() {
		...
		/**
		 * Drag & Drop Layout init.
		 *
		 * Fires on Drag & Drop Layout init, after Drag & Drop Layout has finished loading but
	 ...
	 * Get install time.
	 *
	 * Retrieve the time when Drag & Drop Layout was installed.
	 *
	 * @since 2.6.0
	 * @access public
	 * @static
	 *
	 * @return int Unix timestamp when Drag & Drop Layout was installed.
	 */
	 ...
	 * Init components.
	 *
	 * Initialize Drag & Drop Layout components. Register actions, run setting manager,
	 ...
	 *
	 * Register Drag & Drop Layout support for all the supported post types defined by
	 ...
	 * Register autoloader.
	 *
	 * Drag & Drop Layout autoloader loads all the classes needed to run the plugin.
	 *
	 * @since 1.6.0
	 * @access private
	 */
	 ...
	 * Plugin constructor.
	 *
	 * Initializing Drag & Drop Layout plugin.
	 *
	 * @since 1.0.0
	 * @access private
	 */
	private function __construct() {
		...
		$GLOBALS['moduleBase'] = new Component();
