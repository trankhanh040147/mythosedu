...
/**
 * Drag & Drop Layout elements manager.
 *
 * Drag & Drop Layout elements manager handler class is responsible for registering and
...
class Elements_Manager {
	 ...
	 *
	 * Initializing Drag & Drop Layout elements manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Init elements.
	 *
	 * Initialize Drag & Drop Layout elements by registering the supported elements.
	 * Drag & Drop Layout supports by default `section` element and `column` element.
	 *
	 * @since 2.0.0
	 * @access private
	 */
	private function init_elements() {
		 ...
		 *
		 * Fires after Drag & Drop Layout elements are registered.
		 *
		 * @since 1.0.0
		 */
	 ...
	 * Require files.
	 *
	 * Require Drag & Drop Layout element base class and column, section and repeater
	 * elements.
	 *
	 * @since 1.0.0
	 * @access private
