...
/**
 * Drag & Drop Layout controls manager.
 *
 * Drag & Drop Layout controls manager handler class is responsible for registering and
...
class Controls_Manager {
	...
	private function register_controls() {
		 ...
		 *
		 * Fires after Drag & Drop Layout controls are registered.
		 *
		 * @since 1.0.0
		 *
	...
	public function get_teaser_template( $texts ) {
		...
		<div class="co-nerd-box">
			...
			<div class="co-nerd-box-title"><?php echo $texts['title']; ?></div>
			<?php foreach ( $texts['messages'] as $message ) { ?>
				<div class="co-nerd-box-message"><?php echo $message; ?></div>
			<?php }

			if ( $texts['link'] ) { ?>
				<a class="co-nerd-box-link co-button co-button-default co-button-go-pro" href="<?php echo Utils::get_pro_link( $texts['link'] ); ?>" target="_blank">
