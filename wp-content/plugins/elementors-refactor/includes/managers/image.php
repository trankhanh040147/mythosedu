...
/**
 * Drag & Drop Layout images manager.
 *
 * Drag & Drop Layout images manager handler class is responsible for retrieving image
 * details.
 *
 * @since 1.0.0
 */
class Images_Manager {
	 ...
	 *
	 * Initializing Drag & Drop Layout images manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
