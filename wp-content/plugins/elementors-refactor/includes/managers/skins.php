...
/**
 * Drag & Drop Layout skins manager.
 *
 * Drag & Drop Layout skins manager handler class is responsible for registering and
...
class Skins_Manager {
	 ...
	 * @param Skin_Base   $skin   Drag & Drop Layout skin.
	 *
	 ...
	 *
	 * @param Widget_Base $widget  Drag & Drop Layout widget.
	 * @param string      $skin_id Drag & Drop Layout skin ID.
	 *
	 ...
	 *
	 * Initializing Drag & Drop Layout skins manager by requiring the skin base class.
	 *
	 * @since 1.0.0
	 * @access public
	 */
