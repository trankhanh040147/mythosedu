...
/**
 * Drag & Drop Layout maintenance mode.
 *
 * Drag & Drop Layout maintenance mode handler class is responsible for the Elementor
...
class Maintenance_Mode {
	 ...
	 *
	 * Adds new "Maintenance Mode" settings fields to Drag & Drop Layout admin page.
	 *
						...
						'fields' => [
							'maintenance_mode_mode' => [
								...
								'field_args' => [
									...
									'desc' => '<div class="co-maintenance-mode-description" data-value="" style="display: none">' .
											  __( 'Choose between Coming Soon mode (returning HTTP 200 code) or Maintenance Mode (returning HTTP 503 code).', 'elementor' ) .
											  '</div>' .
											  '<div class="co-maintenance-mode-description" data-value="maintenance" style="display: none">' .
											  ...
											  '</div>' .
											  '<div class="co-maintenance-mode-description" data-value="coming_soon" style="display: none">' .
	...
	public function add_menu_in_admin_bar( \WP_Admin_Bar $wp_admin_bar ) {
		...
		$wp_admin_bar->add_node( [
			'id' => 'co-maintenance-edit',
			'parent' => 'co-maintenance-on',
	...
	public function print_style() {
		?>
		<style>#wp-admin-bar-co-maintenance-on > a { background-color: #dc3232; }
			#wp-admin-bar-co-maintenance-on > .ab-item:before { content: "\f160"; top: 2px; }</style>
		<?php
	}
	 ...
	 *
	 * Initializing Drag & Drop Layout maintenance mode.
	 *
	 * @since 1.4.0
	 * @access public
	 */
	...
	private function print_template_description() {
		...
		?>
		<a target="_blank" class="co-edit-template" style="display: none" href="<?php echo $edit_url; ?>"><?php echo __( 'Edit Template', 'elementor' ); ?></a>
		<div class="co-maintenance-mode-error"><?php echo __( 'To enable maintenance mode you have to set a template for the maintenance mode page.', 'elementor' ); ?></div>
		<div class="co-maintenance-mode-error"><?php echo sprintf( __( 'Select one or go ahead and <a target="_blank" href="%s">create one</a> now.', 'elementor' ), admin_url( 'post-new.php?post_type=' . Source_Local::CPT ) ); ?></div>
		<?php
	}
}
