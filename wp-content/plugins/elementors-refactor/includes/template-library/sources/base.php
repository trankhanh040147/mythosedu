...
/**
 * Drag & Drop Layout template library source base.
 *
 * Drag & Drop Layout template library source base handler class is responsible for
 * initializing all the methods controlling the source of Drag & Drop Layout templates.
 *
 * @since 1.0.0
 * @abstract
 */
abstract class Source_Base {
	 ...
	 *
	 * Retrieve Drag & Drop Layout meta data for the current user.
	 *
	 * @since 1.9.0
	 * @access public
	 *
	 ...
	 *
	 * For any given Drag & Drop Layout content/data, replace the IDs with new randomly
	 * generated IDs.
	 *
	 * @since 1.0.0
	 * @access protected
	 *
	 * @param array $content Any type of Drag & Drop Layout data.
	 *
	...
	/**
	 * Get Drag & Drop Layout library user meta prefix.
	 *
	 * Retrieve user meta prefix used to save Drag & Drop Layout data.
	 *
	 * @since 1.9.0
	 * @access protected
	 *
