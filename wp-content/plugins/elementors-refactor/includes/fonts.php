...
/**
 * Drag & Drop Layout fonts.
 *
 * Drag & Drop Layout fonts handler class is responsible for registering the supported
...
class Fonts {
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			 ...
			 * Additional fonts.
			 *
			 * Filters the fonts used by Drag & Drop Layout to add additional fonts.
			 *
			 * @since 1.9.4
			 *
			 * @param array $additional_fonts Additional Drag & Drop Layout fonts.
			 */
	...
	/**
	 * Get Drag & Drop Layout native fonts.
	 *
	 * Retrieve the list of supported fonts.
	 *
	 * @since 1.9.4
