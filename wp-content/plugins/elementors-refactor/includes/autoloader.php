...
/**
 * Drag & Drop Layout autoloader.
 *
 * Drag & Drop Layout autoloader handler class is responsible for loading the different
...
class Autoloader {
	 ...
	 * Classes map.
	 *
	 * Maps Drag & Drop Layout classes to file names.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
	 ...
	 * Classes aliases.
	 *
	 * Maps Drag & Drop Layout classes to aliases.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
