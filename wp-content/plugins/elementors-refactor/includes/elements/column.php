...
/**
 * Drag & Drop Layout column element.
 *
 * Drag & Drop Layout column handler class is responsible for initializing the column
 * element.
 *
 * @since 1.0.0
 */
class Element_Column extends Element_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'.co-bc-flex-widget {{WRAPPER}}.co-column .co-column-wrap' => 'align-items: {{VALUE}}',
					// This specificity is intended to make sure column css overwrites section css on vertical alignment (content_position)
					'{{WRAPPER}}.co-column.co-element[data-element_type="column"] > .co-column-wrap.co-element-populated > .co-widget-wrap' => 'align-content: {{VALUE}}; align-items: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.co-column > .co-column-wrap > .co-widget-wrap' => 'justify-content: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'placeholder' => 20,
				'selectors' => [
					'{{WRAPPER}} > .co-column-wrap > .co-widget-wrap > .co-widget:not(.co-widget__width-auto):not(.co-widget__width-initial):not(:last-child):not(.co-absolute)' => 'margin-bottom: {{VALUE}}px', //Need the full path for exclude the inner section
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:not(.co-motion-effects-element-type-background) > .co-column-wrap, {{WRAPPER}} > .co-column-wrap > .co-motion-effects-container > .co-motion-effects-layer',
				'fields_options' => [
					'background' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover > .co-element-populated',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} > .co-element-populated >  .co-background-overlay',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated >  .co-background-overlay' => 'opacity: {{SIZE}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated > .co-background-overlay' => 'mix-blend-mode: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover > .co-element-populated >  .co-background-overlay',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}:hover > .co-element-populated >  .co-background-overlay' => 'opacity: {{SIZE}};',
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				'name' => 'border',
				'selector' => '{{WRAPPER}} > .co-element-populated',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated, {{WRAPPER}} > .co-element-populated > .co-background-overlay, {{WRAPPER}} > .co-background-slideshow' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}}:hover > .co-element-populated, {{WRAPPER}}:hover > .co-element-populated > .co-background-overlay' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated' => 'transition: background {{background_hover_transition.SIZE}}s, border {{SIZE}}s, border-radius {{SIZE}}s, box-shadow {{SIZE}}s',
					'{{WRAPPER}} > .co-element-populated > .co-background-overlay' => 'transition: background {{background_overlay_hover_transition.SIZE}}s, border-radius {{SIZE}}s, opacity {{background_overlay_hover_transition.SIZE}}s',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .co-element-populated .co-heading-title' => 'color: {{VALUE}};',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .co-element-populated a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .co-element-populated a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .co-element-populated' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function content_template() {
		?>
		<div class="co-column-wrap">
			<div class="co-background-overlay"></div>
			<div class="co-widget-wrap"></div>
		</div>
		<?php
	}
	...
	public function before_render() {
		...
		$column_wrap_classes = [ 'co-column-wrap' ];

		if ( $this->get_children() ) {
			$column_wrap_classes[] = ' co-element-populated';
		}
		...
		$this->add_render_attribute( [
			...
			'_widget_wrapper' => [
				'class' => [ 'co-widget-wrap' ],
			],
			'_background_overlay' => [
				'class' => [ 'co-background-overlay' ],
			],
		] );
		?>
	...
	protected function _add_render_attributes() {
		...
		$this->add_render_attribute(
			'_wrapper', 'class', [
				'co-column',
				'co-col-' . $settings['_column_size'],
				'co-' . $column_type . '-column',
			]
		);
	}
