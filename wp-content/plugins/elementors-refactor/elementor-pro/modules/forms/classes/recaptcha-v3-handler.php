...
class Recaptcha_V3_Handler extends Recaptcha_Handler {
	...
	public static function get_setup_message() {
		return __( 'To use reCAPTCHA V3, you need to add the API Key and complete the setup process in Dashboard > Drag & Drop Layout > Settings > Integrations > reCAPTCHA V3.', 'elementor-pro' );
	}
