...
class Discord extends Action_Base {
	...
	public function run( $record, $ajax_handler ) {
		...
		$embeds = [
			...
			'author' => [
				'name'     => isset( $settings['discord_username'] ) ? $settings['discord_username'] : __( 'Drag & Drop Layout Forms', 'elementor-pro' ),
				'url'      => $page_url,
		...
		if ( ! empty( $settings['discord_ts'] ) && 'yes' === $settings['discord_ts'] ) {
			...
			$embeds['footer'] = [
				'text' => sprintf( __( 'Powered by %s', 'elementor-pro' ), 'Drag & Drop Layout' ),
