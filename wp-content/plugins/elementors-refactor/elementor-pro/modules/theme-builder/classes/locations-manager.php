...
class Locations_Manager {
	...
	public function register_locations() {
		...
		if ( ! did_action( 'elementor/theme/register_locations' ) ) {
			 ...
			 *
			 * This is where Drag & Drop Layout theme locations are registered by
			 * external themes.
			 *
			 * @since 2.0.0
			 *
	...
	public function do_location( $location ) {
		 ...
		 *
		 * Fires before Drag & Drop Layout location was printed.
		 *
		 ...
		 *
		 * Fires after Drag & Drop Layout location was printed.
		 *
		 * The dynamic portion of the hook name, `$location`, refers to the location name.
		 *
		 * @since 2.0.0
