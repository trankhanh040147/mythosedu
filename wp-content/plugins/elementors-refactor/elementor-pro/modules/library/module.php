...
class Module extends Module_Base {
	...
	public function add_filters() {
		...
		/**
		 * @deprecated 2.6.0 The following filters will be removed in Drag & Drop Layout Pro 2.9.0:
		 */
	...
	public static function empty_templates_message() {
		return '<div id="elementor-widget-template-empty-templates">
				...
				<div class="elementor-widget-template-empty-templates-footer">' . __( 'Want to learn more about Drag & Drop Layout library?', 'elementor-pro' ) . ' <a class="elementor-widget-template-empty-templates-footer-url" href="#" target="_blank">' . __( 'Click Here', 'elementor-pro' ) . '</a>
				</div>
				</div>';
	}
}
