...
class Fonts_Manager {
	...
	public function register_admin_menu() {
		$menu_title = _x( 'Custom Fonts', 'Drag & Drop Layout Font', 'elementor-pro' );
		add_submenu_page(
			Settings::PAGE_ID,
			$menu_title,
			$menu_title,
	...
	/**
	 * runs on Drag & Drop Layout font post save and calls the font type handler save meta method
	 *
	 * @param int      $post_id
	 * @param \WP_Post $post
	 * @param bool     $update
	...
	protected function actions() {
		...
		/**
		 * Drag & Drop Layout fonts manager loaded.
		 *
