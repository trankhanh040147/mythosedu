    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        var SlidesHandler = elementorModules.frontend.handlers.Base.extend({
            ...
            getSwiperOptions: function getSwiperOptions() {
                ...
                if (elementSettings.item_spacing_custom) {
                    swiperOptions.spaceBetween = +elementSettings.item_spacing_custom.size;
                }
            ...
            updateSpaceBetween: function updateSpaceBetween() {
                this.swipers.main.params.spaceBetween = this.getElementSettings('item_spacing_custom').size || 0;
                this.swipers.main.update();
            },
            onElementChange: function onElementChange(propertyName) {
                if (1 >= this.getSlidesCount()) {
                ...
                if (0 === propertyName.indexOf('item_spacing_custom')) {
                    this.updateSpaceBetween();
                }else if (0 === propertyName.indexOf('width')) {
                    this.swipers.main.update();
                }
            },
            onEditSettingsChange: function onEditSettingsChange(propertyName) {
