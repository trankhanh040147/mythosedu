...
/**
 * Plugin Name: Drag & Drop Layout Safe Mode
 ...
 * @category Safe Mode
 *
 * Drag & Drop Layout is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * any later version.
 *
 * Drag & Drop Layout is distributed in the hope that it will be useful,
...
class Safe_Mode {
	...
	public function is_requested() {
		return ! empty( $_REQUEST['co-mode'] ) && 'safe' === $_REQUEST['co-mode'];
	}
	...
	public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
		if ( basename( __FILE__ ) === $plugin_file ) {
			$row_meta = [
				'docs' => '<a href="#" aria-label="' . esc_attr( __( 'Learn More', 'elementor' ) ) . '" target="_blank">' . __( 'Learn More', 'elementor' ) . '</a>',
			];
