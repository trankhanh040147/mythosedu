...
/**
 * Drag & Drop Layout Page Builder cli tools.
 */
class Library extends \WP_CLI_Command {

	/**
	 * Sync Drag & Drop Layout Library.
	 *
	 * [--network]
	 ...
	 *      - This will sync the library with Drag & Drop Layout cloud library.
	 *
	 *  2. wp elementor library sync --force
	 *      - This will sync the library with Drag & Drop Layout cloud even if it's looks like that the library is already up to date.
	 *
	 *  3. wp elementor library sync --network
	 *      - This will sync the library with Drag & Drop Layout cloud library for each site in the network if needed.
	 *
	 * @since 2.8.0
	 * @access public
	 */
	...
	/**
	 * Connect site to Drag & Drop Layout Library.
	 ...
	 *
	 * --token
	 *      A connect token from Drag & Drop Layout Account Dashboard.
	 *
	 * ## EXAMPLES
	 *
	 *  1. wp elementor library connect --user=admin --token=<connect-cli-token>
	 *      - This will connect the admin to Drag & Drop Layout library.
	 *
	 * @param $args
	 * @param $assoc_args
	 *
	...
	/**
	 * Disconnect site from Drag & Drop Layout Library.
	 *
	 * --user
	 ...
	 *      - This will disconnect the admin from Drag & Drop Layout library.
	 *
	 * @param $args
	 * @param $assoc_args
	 *
