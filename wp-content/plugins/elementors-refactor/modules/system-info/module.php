...
/**
 * Drag & Drop Layout system info module.
 *
 * Drag & Drop Layout system info module handler class is responsible for registering and
 * managing Drag & Drop Layout system info reports.
 *
 * @since 2.9.0
 */
class Module extends BaseModule {
	 ...
	 *
	 * Holds the user capabilities required to manage Drag & Drop Layout menus.
	 *
	 * @since 2.9.0
	 * @access private
	 *
	...
	/**
	 * Drag & Drop Layout system info reports.
	 *
	 * Holds an array of available reports in Drag & Drop Layout system info page.
	 *
	 * @since 2.9.0
	 * @access private
	 *
	 ...
	 *
	 * Initializing Drag & Drop Layout system info page.
	 *
	 * @since 2.9.0
	 * @access public
	 */
	 ...
	 * Register admin menu.
	 *
	 * Add new Drag & Drop Layout system info admin menu.
	 *
	...
	public function display_page() {
		...
		<div id="co-system-info">
			...
			<div id="co-system-info-raw">
				<label id="co-system-info-raw-code-label" for="co-system-info-raw-code"><?php echo __( 'You can copy the below info as simple text with Ctrl+C / Ctrl+V:', 'elementor' ); ?></label>
				<textarea id="co-system-info-raw-code" readonly>
					<?php
				...
				<script>
					var textarea = document.getElementById( 'co-system-info-raw-code' );
	 ...
	 * Create a report.
	 *
	 * Register a new report that will be displayed in Drag & Drop Layout system info page.
	 *
	 ...
	 * Get allowed reports.
	 *
	 * Retrieve the available reports in Drag & Drop Layout system info page.
	 *
	 * @since 2.9.0
	 * @access public
	 * @static
	 *
	 * @return array Available reports in Drag & Drop Layout system info page.
	 */
	 ...
	 * Add report.
	 *
	 * Register a new report to Drag & Drop Layout system info page.
	 *
	 * @since 2.9.0
	 * @access public
	 * @static
