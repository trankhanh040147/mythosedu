...
/**
 * Drag & Drop Layout page templates module.
 *
 * Drag & Drop Layout page templates module handler class is responsible for registering
 * and managing Drag & Drop Layout page templates modules.
 *
 * @since 2.0.0
 */
class Module extends BaseModule {
	...
	/**
	 * Drag & Drop Layout Canvas template name.
	 */
	const TEMPLATE_CANVAS = 'elementor_canvas';

	/**
	 * Drag & Drop Layout Header & Footer template name.
	 */
	 ...
	 * Template include.
	 *
	 * Update the path for the Drag & Drop Layout Canvas template.
	 *
	 ...
	 *
	 * Adds Drag & Drop Layout templates to all the post types that support
	 * Elementor.
	 *
	 ...
	 * Add page templates.
	 *
	 * Add the Drag & Drop Layout page templates to the theme templates.
	 *
	...
	public function add_page_templates( $page_templates, $wp_theme, $post ) {
		...
		$page_templates = [
			self::TEMPLATE_CANVAS => _x( 'Drag & Drop Layout Canvas', 'Page Template', 'elementor' ),
			self::TEMPLATE_HEADER_FOOTER => _x( 'Drag & Drop Layout Full Width', 'Page Template', 'elementor' ),
		] + $page_templates;
	 ...
	 *
	 * Drag & Drop Layout don't allow WordPress to update the parent page template
	 ...
	 *
	 * Initializing Drag & Drop Layout page templates module.
	 *
	 * @since 2.0.0
	 * @access public
	 */
