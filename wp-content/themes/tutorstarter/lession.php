...
<head>
  <link rel="stylesheet" type="text/css"
    href="<?php echo get_template_directory_uri(); ?>/assets/dist/css/style_lession.css">
...
<div class="___header2 ___container">
        ...
        <div class="___col_lg_6 ___right_header2 d-flex justify-content-end align-items-center">
          <div class="__key d-flex">
            <img src="/wp-content/uploads/2023/11/icon-key.svg" alt="">
  ...
  <section class="__lession position-relative">
    ...
    <div class=" col-12 d-flex justify-content-end position-absolute __box-btn">
        <button class=" __btn-prev"> <img src="/wp-content/uploads/2023/11/btn-prev.svg" alt="" class="__btn_prev"></button>
        <button class=" __btn-next"> <img src="/wp-content/uploads/2023/11/btn-next.svg" alt="" class="__btn_next"></button>
    </div>
  </section>
  <div class="col-12 modal-end">
    <p>Kết thúc trò chơi phần này </p>
    <a href="/?page_id=6651?id=" class="__btn-endgame">
      <p>Quay lại map</p>
    </a>
  </div>
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/assets/dist/js/page_lession.js?v=1.1"></script>
