...
wp_enqueue_style('game_sort_css', get_template_directory_uri() . '/component/css/sort_increase.css', array(), '1.2', false);
...
<?php
    ...
    wp_enqueue_script('game_plus_js', get_template_directory_uri() . '/component/js/sort_increase.js', array(), '1.1', true);
?>
